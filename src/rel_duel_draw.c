...
/* func_00001F3C — 14 words. MATCH 100% (verified). */
extern void func_000034FC(void *, s32, s32);
void func_00001F3C(void) {
    extern char D_0007EB38;
    char *a0 = *(char **)&D_0007EB38;
    if (*(s32 *)(a0 + 0x68) != 0) {
        *(s32 *)(a0 + 0x68) = 0;
        func_000034FC(a0, *(s32 *)(a0 + 0x58), 0);
    }
}
...
/* func_00002484 — 14 words. MATCH 100% (verified). */
extern s32 func_00003380(s32);
s32 func_00002484(void) {
    extern char D_0007EB30;
    char *v1 = &D_0007EB30;
    if ((*(s32 *)&D_0007EB40) != 0) {
        return 1;
    }
    return func_00003380(*(s32 *)(v1 + 8));
}
...
/* func_000027C0 — 13 words. MATCH 100% (verified). */
void func_000027C0(s32 arg0, s32 arg1) {
    char *a2 = &D_0007F2E0;
    if (arg1 != 0) {
        *(s32 *)(a2 + 0xC) = arg0;
        *(s32 *)(a2 + 0x10) = arg0;
...
/* func_0000CD0C — 16 words. MATCH 100% (verified). */
void func_0000CD0C(void) {
    extern void *ehsys_0939B6BE(void *, s32, s32, s32, s32);
    void *v0 = (void *)ehsys_DFCA450B(7, 0);
    void *v1 = ehsys_0939B6BE(v0, 0x800, 0x800, 0x1E0, 0x110);
    ehsys_1EC5342B(v1);
}
...
/* func_0001549C — 16 words. MATCH 100% (verified). */
typedef struct { char pad[0x24]; s32 f24; } S_1549C;
extern s32 func_000318A0(void);
/* func_00015314 — 25 words. MATCH 100% (shape: m2c). */
void func_00015314(void) {
    extern int D_00090ED0;
    extern int ehsys_1D98951B();
    extern int ehsys_1EC5342B();
    extern int ehsys_399AC68A();
    extern int ehsys_42110BF9();
    extern int ehsys_C62F9EAC();
    extern int ehsys_DFCA450B();
    extern int func_00015314();
    D_00090ED0 = 1;
    ehsys_1EC5342B(ehsys_C62F9EAC(ehsys_399AC68A(ehsys_42110BF9(ehsys_1D98951B(ehsys_DFCA450B(3, 0), -0x01000000), 0), 0), 0x17));
}
void func_0001549C(S_1549C *arg0) {
    S_1549C *s0 = arg0;
    if (s0->f24 != -1) {
        func_000318A0();
        s0->f24 = -1;
...
/* func_000183AC — 15 words. MATCH 100% (verified). */
void func_000183AC(void) {
    extern int func_00019500();
...
/* func_000194AC — 16 words. MATCH 100% (verified). */
typedef struct { s32 a, b, c, d, e; f32 f; s32 g; } S7_194AC;
void *func_000194AC(S7_194AC *arg0, S7_194AC *arg1) {
    arg0->a = arg1->a;
    arg0->b = arg1->b;
    arg0->c = arg1->c;
    arg0->d = arg1->d;
...
/* func_00019C44 — 45 words. MATCH 100% (shape: lead-dummy1 asm-fields). */
void func_00019C44(s32 unused0, int arg1) {
    ...
    extern int ehsys_FD84C4D3();
    extern int func_00019C44();
    ehsys_1EC5342B(ehsys_FD84C4D3(ehsys_CABEA834(ehsys_4175E3DB(ehsys_5CBB9E43(ehsys_E6E4401F(ehsys_09794DF0(ehsys_F462EE6E(ehsys_F462EE6E(ehsys_DFCA450B(7, 0), 9), 4), 0, 1), 0, 0), 0, 2, 3, 0, 0), 1), -1), 0x104, 0x2D, (*(int *)((char *)arg1 + 0x8))));
}
...
/* func_0001A138 — 47 words. MATCH 100% (shape: lead-dummy1 asm-fields). */
void func_0001A138(s32 unused0, int arg1) {
    extern int ehsys_09794DF0();
    extern int ehsys_1EC5342B();
    extern int ehsys_4175E3DB();
    extern int ehsys_5CBB9E43();
    ...
    extern int ehsys_F462EE6E();
    extern int ehsys_FD84C4D3();
    extern int func_0001A138();
    if ((*(int *)((char *)arg1 + 0x20)) == 0) {
        ehsys_1EC5342B(ehsys_FD84C4D3(ehsys_CABEA834(ehsys_4175E3DB(ehsys_5CBB9E43(ehsys_E6E4401F(ehsys_09794DF0(ehsys_F462EE6E(ehsys_F462EE6E(ehsys_DFCA450B(7, 0), 9), 4), 0, 1), 0, 0), 0, 2, 3, 0, 0), 1), -1), 0x104, 0x2D, (*(int *)((char *)arg1 + 0xC))));
    }
}
...
/* func_0001CA60 — 22 words. MATCH 100% (shape: m2c asm-fields). */
void func_0001CA60(int arg0) {
    extern int duel_eng_F12A76B5();
    extern int ehsys_4BF558F1();
    extern int func_000088F4();
    extern int func_000194EC();
    extern int func_0001CA60();
    int temp_s0;
    temp_s0 = (*(int *)((char *)arg0 + 0x18));
    ehsys_4BF558F1(0);
    if ((*(int *)((char *)temp_s0 + 0xC)) != 0) {
        duel_eng_F12A76B5();
        func_000088F4((s32) (*(short *)((char *)temp_s0 + 0x0)), (s32) (*(short *)((char *)temp_s0 + 0x2)), (*(int *)((char *)temp_s0 + 0x4)), 0);
        func_000194EC();
    }
}
...
/* func_0003066C — 10 words. MATCH 100% (verified). */
extern s32 *func_00031974();
int func_0003066C(s32 arg0, s32 arg1) {
    s32 *v0 = func_00031974(arg0);
    *(s32 *)((char *)v0 + 0x5DC) = arg1;
}

/* func_00030694 — 10 words. MATCH 100% (verified). */
extern s32 *func_00031974();
...
/* func_00031974 — 10 words. MATCH 100% (verified). */
extern void *func_00031718(void);
s32 *func_00031974(s32 arg0) {
    void *v0 = func_00031718();
    s32 *r;
    if (v0 == 0) {
        r = 0;
    } else {
...
/* func_00032744 — 16 words. MATCH 100% (verified). */
extern void ehsys_3325AA47(void *);
extern s32 func_00032B08(void *, void *);
extern void ehsys_91EFFDC1(s32, void *);
int func_00032744(arg0)
s32 arg0;
{
    char buf[0x40];
    ehsys_3325AA47(buf);
    func_00032B08(buf, buf);
...
/* func_000327F8 — 13 words. MATCH 100% (verified). */
void func_000327F8(s32 arg0) {
    extern int func_00032744();
    s32 buf[16];
...
/* func_00032C2C — 31 words. MATCH 100% (shape: m2c). */
void func_00032C2C(void) {
    extern int D_00093690;
    extern int D_000936D0;
    extern int D_00093710;
    extern int D_00093750;
    extern int D_00093790;
    extern int ehsys_1507D27D();
    extern int ehsys_4F22C9AA();
    extern int ehsys_5739D1F8();
    extern int func_00032C2C();
    ehsys_4F22C9AA(0);
    ehsys_5739D1F8((s32) &D_00093690);
    ehsys_4F22C9AA(1);
    ehsys_5739D1F8((s32) &D_000936D0);
    ehsys_4F22C9AA(3);
    ehsys_5739D1F8((s32) &D_00093710);
    ehsys_4F22C9AA(2);
    ehsys_5739D1F8((s32) &D_00093750);
    ehsys_1507D27D((s32) &D_00093790, (s32) (((int)&D_00093790) + 4), (s32) (((int)&D_00093790) + 8), (s32) (((int)&D_00093790) + 0xC));
}
...
/* func_00032EE8 — 10 words. MATCH 100% (verified). */
f32 func_00032EE8(s32 arg0, s32 arg1) {
    return 1.0f - func_00032EB4(arg0, arg1);
}
...
/* func_00032FB4 — 10 words. MATCH 100% (verified). */
extern f32 func_00032F3C(s32, s32);
f32 func_00032FB4(s32 arg0, s32 arg1) {
    return 1.0f - func_00032F3C(arg0, arg1);
}

/* func_0003306C — 10 words. MATCH 100% (verified). */
f32 func_0003306C(s32 arg0, s32 arg1) {
    extern f32 func_00032FDC();
    return 1.0f - func_00032FDC(arg0, arg1);
}
...
/* func_000333A0 — 16 words. MATCH 100% (verified). */
extern f32 ehsys_295BF133(s32, f32, f32, f32);
void func_000333A0(s32 arg0, s32 arg1) {
    char buf[0x40];
    func_00002510((s32)buf, arg0);
    ehsys_295BF133(arg1, *(f32 *)(buf + 0x30), *(f32 *)(buf + 0x34), *(f32 *)(buf + 0x38));
}

/* func_000333E0 — 16 words. MATCH 100% (verified). */
void func_000333E0(s32 arg0, s32 arg1) {
    char buf[0x40];
    func_00002524((s32)buf, arg0);
    ehsys_295BF133(arg1, *(f32 *)(buf + 0x30), *(f32 *)(buf + 0x34), *(f32 *)(buf + 0x38));
}
...
/* func_0003F75C — 23 words. MATCH 100% (shape: spawn-set). */
extern int func_0003176C();
extern int *func_00031974();
...
/* func_000409DC — 23 words. MATCH 100% (shape: spawn-set). */
extern int func_0003176C();
extern int *func_00031974();
extern void func_00040B5C();
int func_000409DC(int arg0, int arg1, int arg2) {

    int h = func_0003176C(&func_00040B5C, arg1, arg2, 0xD564, 0);
    if (h != -1) { func_00031974(h)[5] = arg0; }
    return h;
}
/* func_00041A5C — 23 words. MATCH 100% (shape: spawn-set). */
extern int func_0003176C();
extern int *func_00031974();
extern void func_00041AB8();
int func_00041A5C(int arg0, int arg1, int arg2) {

    int h = func_0003176C(&func_00041AB8, arg1, arg2, 0xE62C, 0);
    if (h != -1) { func_00031974(h)[5] = arg0; }
    return h;
}
...
/* func_00043610 — 23 words. MATCH 100% (shape: spawn-set). */
extern int func_0003176C();
extern int *func_00031974();
extern void func_0004366C();
int func_00043610(int arg0, int arg1, int arg2) {

    int h = func_0003176C(&func_0004366C, arg1, arg2, 0xB084, 0);
    if (h != -1) { func_00031974(h)[4] = arg0; }
    return h;
}
...
/* func_000445B8 — 10 words. MATCH 100% (verified). */
typedef struct { s32 a; f32 b, c, d; } S4_445B8;
void *func_000445B8(S4_445B8 *arg0, S4_445B8 *arg1) {
    arg0->a = arg1->a;
    arg0->b = arg1->b;
    arg0->c = arg1->c;
    arg0->d = arg1->d;
...
/* func_0004F4F8 — 15 words. MATCH 100% (verified). */
s32 func_0004F4F8(s32 arg0, s32 arg1) {
    extern int func_0006DE5C();
    extern void func_00051824(s32, s32);
    s32 v0 = func_0006DE5C(arg0, arg1);
    u8 a1 = !arg1;
    func_00051824(v0, a1);
    return 1;
}
...
/* func_0004FD4C — 4 words. MATCH 100% (verified). */
extern s32 func_00053984(s32);
s32 func_0004FD4C(s32 arg0) {
    u8 b = !arg0;
    return func_00053984(b);
}
...
/* func_00050F60 — 14 words. MATCH 100% (verified). */
void *func_00050F60(s32 arg0) {
    extern void *ehsys_88B6C7F0();
    void *v0 = ehsys_88B6C7F0(arg0);
    return (char *)v0 + arg0 * 0x1F8 + 0x108;
}
...
/* func_00051618 — 6 words. MATCH 100% (verified). */
void func_00051618(s32 arg0) {
    extern s32 D_00094108;
    u8 b = !arg0;
    D_00094108 = b;
}
...
/* func_00051824 — 14 words. MATCH 100% (verified). */
void func_00051824(s32 arg0, s32 arg1) {
    extern int func_0006DE7C();
    s32 v0 = func_0006DE7C(arg0);
    (&D_00094124)[v0] = (void *)arg1;
}
...
/* func_000550FC — 14 words. MATCH 100% (verified). */
extern s32 func_00067CEC(void);
void func_000550FC(void) {
    extern int ehsys_frame_sync();
    s32 v1;
    goto test;
loop:
...
/* func_0005B7A8 — 15 words. MATCH 100% (verified). */
extern s32 func_000539B8();
void func_0005B7A8(void) {
    extern char D_395D7C;
    char *s0 = &D_395D7C;
    s32 v0 = func_000539B8();
    if (v0 != 0) {
        v0 = ehsys_39ADDA9F(s0);
        *(s32 *)(s0 + 0x528) = v0;
    }
}
...
/* func_00060580 — 15 words. MATCH 100% (verified). */
s32 func_00060580(void *arg0) {
    extern void ehsys_memcpy();
    extern char D_396854;
    char *s0 = &D_396854;
    if (arg0 != 0) {
        s32 v0 = *(s32 *)(s0 + 0x1720);
        ehsys_memcpy(arg0, s0 + 0x1724, v0 * 4);
    }
    return *(s32 *)(s0 + 0x1720);
}
...
/* func_00065004 — 0 words. MATCH 100% (shape: same-shape twin). */
void func_00065004(s32 arg0, s32 arg1) {
