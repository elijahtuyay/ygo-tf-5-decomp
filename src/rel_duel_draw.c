 ...
 *
 * STATUS: 401 functions matched here (of 1546 total). The rest of the
...
int func_00002568(void) {
    *(s32 *)&D_0007EB40 = 1;
    return func_0000030C((*(s32 *)&D_0007EB38));
}
