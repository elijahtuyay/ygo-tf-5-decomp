...
void func_00004698(int a0, int a1) {
    ...
    extern int D_00325E00;
    extern int D_00325E04;
    extern int func_00004698();
    D_00325DFC = a0;
    D_00325E00 = 0;
    D_00325E04 = a1;
}
...
/* func_00030588 — 31 words. MATCH 100% (shape: m2c). */
s32 func_00030588(s32 arg0, s32 arg1) {
    extern int func_00030588();
    extern int func_0006170C();
    extern int func_0006F96C();
    extern int func_00078AAC();
    extern int func_000820D8();
    s32 temp_s0;

    if (func_00078AAC(arg0, 0xB, arg1) != 0) {
        temp_s0 = 1 - func_000820D8(arg0, 0xB, 0xE);
        func_0006F96C(arg0, arg1);
        func_0006170C(arg0, 0xB, 0xE, temp_s0);
    }
    return 1;
}
...
/* func_0003CC8C — 18 words. MATCH 100% (shape: m2c). */
void func_0003CC8C(s32 arg0, s32 arg1) {
    extern int D_003268E8;
    extern int D_00351784;
    extern int func_0003CC8C();
    extern int func_00040550();
    D_00351784 = arg0;
    if ((&D_003268E8)[arg0] == 0) {
        func_00040550(0x36, 0, arg1, 0);
    }
}
/* func_0003D530 — 20 words. MATCH 100% (shape: m2c). */
void func_0003D530(s32 arg0, s32 arg1, s32 arg2) {
    extern int D_003268E8;
    extern int D_00351784;
    extern int D_003517C8;
    extern int func_0003D530();
    extern int func_00040550();
    D_00351784 = arg0;
    D_003517C8 = arg0;
    if ((&D_003268E8)[arg0] == 0) {
        func_00040550(0x36, 3, arg1, arg2);
    }
}
/* func_0003D950 — 18 words. MATCH 100% (shape: m2c). */
void func_0003D950(s32 arg0, s32 arg1) {
    extern int D_003268E8;
    extern int D_00351784;
    extern int func_0003D950();
    extern int func_00040550();
    D_00351784 = arg0;
    if ((&D_003268E8)[arg0] == 0) {
        func_00040550(0x36, 5, 0xE7, arg1);
    }
}
/* func_0003DC20 — 7 words. MATCH 100% (shape: hand). */
int func_0003DC20(int a0) {
    extern int D_00351784;
    extern int func_00040550();
    extern int func_0003DC20();
    D_00351784 = a0;
    return func_00040550(0x36, 0xC, 0, 0);
}
...
/* func_0003DC3C — 18 words. MATCH 100% (shape: m2c). */
void func_0003DC3C(s32 arg0, s32 arg1) {
    extern int D_003268E8;
    extern int D_00351784;
    extern int func_0003DC3C();
    extern int func_00040550();
    D_00351784 = arg0;
    if ((&D_003268E8)[arg0] == 0) {
        func_00040550(0x36, 0xD, arg1, 0);
    }
}
/* func_0003DC84 — 18 words. MATCH 100% (shape: m2c). */
void func_0003DC84(s32 arg0, s32 arg1, s32 arg2) {
    extern int D_003268E8;
    extern int D_00351784;
    extern int func_0003DC84();
    extern int func_00040550();
    D_00351784 = arg0;
    if ((&D_003268E8)[arg0] == 0) {
        func_00040550(0x36, 0xE, arg1, arg2);
    }
}
...
/* func_0003FF0C — 7 words. MATCH 100% (shape: hand). */
int func_0003FF0C(int a0) {
    extern char D_0034DF44;
...
/* func_000404DC — 13 words. MATCH 100% (shape: m2c). */
u32 func_000404DC(void) {
    extern int D_00351708;
    extern int func_000404DC();
    s32 temp_v1;

    temp_v1 = (D_00351708 * 0x343FD) + 0x269EC3;
    D_00351708 = temp_v1;
    return ((temp_v1 >> 16) & 0x7FFF);
}
/* func_00040510 — 16 words. MATCH 100% (shape: m2c). */
u32 func_00040510(s32 arg0) {
    extern int D_00351708;
    ...
    temp_v1 = (D_00351708 * 0x343FD) + 0x269EC3;
    D_00351708 = temp_v1;
    return (u32) (arg0 * (((temp_v1 >> 16) & 0x7FFF))) >> 0xF;
}
/* func_00041EE0 — 11 words. MATCH 100% (shape: m2c). */
void func_00041EE0(void) {
    extern int D_00326E80;
    extern int func_00041EE0();
    if (D_00326E80 != 0) {
        ((int (*)()) D_00326E80)();
    }
}
...
/* func_00044598 — 19 words. MATCH 100% (shape: m2c). */
s32 func_00044598(void) {
    extern int D_003268E8;
    extern int D_0034CA48;
    extern int D_00351718;
    extern int D_0035173C;
    extern int func_00044598();
    s32 var_v1;

    var_v1 = D_0035173C != 0;
    if (var_v1 != 0) {
        var_v1 = (&D_003268E8)[D_00351718] == 2;
    }
    return (D_0034CA48 + var_v1) > 0;
}
...
int func_0004EADC(void) {
    ...
    extern int func_0004EADC();
    D_0034D6D8 = 0;
    return 1;
}
/* func_0005AA80 — 3 words. MATCH 100% (shape: hand). */
extern int func_0005A860();
/* func_0004FA5C — 13 words. MATCH 100% (shape: m2c). */
void func_0004FA5C(void) {
    extern unsigned short D_0034D6D6;
    extern unsigned short D_0034D6F4;
    extern int func_0004DEA8();
    extern int func_0004FA5C();
    if ((D_0034D6D6 != 0) && (D_0034D6F4 == 0)) {
        D_0034D6F4 = 0xA;
    }
    func_0004DEA8();
}
...
/* func_0005A330 — 14 words. MATCH 100% (shape: m2c). */
void func_0005A330(void) {
    extern unsigned short D_0034D6EE;
    extern unsigned short D_0034D6F0;
    extern unsigned short D_0034D6F4;
    extern unsigned short D_0034D6F6;
    extern unsigned short D_0034D6F8;
    extern unsigned short D_0034D6FA;
    extern int func_0005A330();
    D_0034D6F4 = 0;
    D_0034D6F6 = 0;
    D_0034D6F8 = 0;
    D_0034D6FA = 0;
...
/* func_0005BE7C — 30 words. MATCH 100% (shape: m2c). */
void func_0005BE7C(s32 arg0, s32 arg1, s32 arg2) {
    extern int func_000135F0();
    extern int func_0005BE7C();
    extern int func_000790D0();
    s32 var_v0;

    if (func_000790D0(arg0, arg1) != 0) {
        if (!(arg0 & 1)) {
            var_v0 = 0;
        } else {
            var_v0 = 0x8000;
        }
        func_000135F0((var_v0 | 0x36) & 0xFFFF, ((((arg0 >> 1) & 0xFF)) | 0x100) & 0xFFFF, (arg1 | 0x8000) & 0xFFFF, arg2 & 0xFFFF);
    }
}
...
/* func_0006B27C — 7 words. MATCH 100% (shape: hand). */
void func_0006B27C(void) {
    extern int D_0035182C;
    extern int D_003517EC;
    extern int func_0006B27C();
    D_0035182C = 4;
    D_003517EC = 1;
}
...
/* func_000813A4 — 34 words. MATCH 100% (shape: m2c). */
s32 func_000813A4(s32 arg0, s32 arg1) {
    extern int func_00078EC0();
    extern int func_000813A4();
    s32 temp_v0;
    s32 temp_v0_2;
    s32 var_s0;

    var_s0 = 0x10000;
    temp_v0 = func_00078EC0(arg0, arg1, 0x112F);
    if ((temp_v0 >= 0) && (temp_v0 < 0x10000)) {
        var_s0 = temp_v0;
    }
    temp_v0_2 = func_00078EC0(arg0, arg1, 0x1130);
    if ((temp_v0_2 >= 0) && (temp_v0_2 < var_s0)) {
        var_s0 = temp_v0_2;
    }
...
void func_00083C80(void) {
    extern int D_0034E780;
    extern int D_0034F2BC;
    extern int func_00083C80();
    D_0034E780 &= ~8;
    D_0034F2BC &= ~8;
}
/* func_00088198 — 4 words. MATCH 100% (shape: hand). */
int func_00088198(int a0) {
    extern int func_002EED24();
    extern int func_00088198();
    extern int D_002FF6A0;
    return func_002EED24(a0, ((int)&D_002FF6A0), 0x32);
}
...
/* func_0008D080 — 14 words. MATCH 100% (shape: bool-fold). */
s32 func_0008D080(s32 arg0) {
    extern int func_0008CCB0();
    extern int func_0008D080();
    extern int func_0008D0B8();
    if (!func_0008CCB0(arg0, 0)) {
        return -1;
    }
    return func_0008D0B8(arg0);
}
...
/* func_00090344 — 17 words. MATCH 100% (shape: guarded-call). */
extern int func_000A16BC();
extern int func_00090164();
int func_00090344(int arg0, int arg1) {

    return func_000A16BC(arg0) ? func_00090164(arg0, arg1) : 0;
}
...
/* func_0009F658 — 10 words. MATCH 100% (shape: hand). */
int func_0009F658(int a0, int a1) {
    extern int func_000996FC();
    extern int func_0009F658();
    int buf[13];
    func_000996FC(a0, a1, buf, 0, 0);
    return buf[7];
}
/* func_0009F6A8 — 10 words. MATCH 100% (shape: hand). */
int func_0009F6A8(int a0, int a1) {
    extern int func_000996FC();
...
/* func_0009F6D0 — 10 words. MATCH 100% (shape: hand). */
int func_0009F6D0(int a0, int a1) {
    extern int func_00098B64();
    extern int func_0009F6D0();
    int buf[13];
    func_00098B64(a0, a1, buf, 0, 0);
    return buf[10];
}
/* func_0009F680 — 10 words. MATCH 100% (shape: hand). */
int func_0009F680(int a0, int a1) {
    extern int func_00098B64();
...
/* func_000A2608 — 9 words. MATCH 100% (shape: hand). */
int func_000A2608(void) {
    extern int func_0008A0D0();
    extern int func_000A2608();
    return !func_0008A0D0(0x1DD1);
}
...
/* func_000A2AEC — 17 words. MATCH 100% (shape: m2c). */
s32 func_000A2AEC(s32 arg0, s32 arg1) {
    extern int func_00078C8C();
    extern int func_000A2AEC();
    if (((u32) (arg1 - 3) < 2U) && (func_00078C8C(arg0, 0xB, 0x2146, 1) != 0)) {
        return 0;
    }
    return 1;
}
...
/* func_000A3880 — 9 words. MATCH 100% (shape: hand). */
int func_000A3880(void) {
    extern int func_0008A0D0();
    extern int func_000A3880();
    return !func_0008A0D0(0x1F5C);
}
...
/* func_000A3DD8 — 9 words. MATCH 100% (shape: hand). */
int func_000A3DD8(void) {
    extern int func_0008A0D0();
    extern int func_000A3DD8();
    return !func_0008A0D0(0x1EB2);
}
...
extern int func_000ACAC8();
/* func_000AEEE0 — 14 words. MATCH 100% (shape: m2c asm-fields). */
void func_000AEEE0(void *arg0, s32 arg1, s32 arg2) {
    extern int func_000AEEE0();
    extern int func_000AF2A4();
    extern int func_000B88B0();
    if ((*(unsigned short *)((char *)arg0 + 0x2)) == arg1) {
        func_000B88B0((s32) arg0, arg1, arg2);
        return;
    }
    func_000AF2A4((s32) arg0, arg1, arg2);
}
...
extern int func_000ACAC8();
/* func_000AF23C — 23 words. MATCH 100% (shape: bool-fold). */
s32 func_000AF23C(s32 arg0, s32 arg1, s32 arg2) {
    extern int func_000A4934();
    extern int func_000ACAC8();
    extern int func_000AF23C();
    if (!func_000A4934(arg0)) {
        return func_000ACAC8(arg0, arg1, arg2, 0x13);
    }
    return 1;
}
...
/* func_000B2C2C — 14 words. MATCH 100% (shape: m2c asm-fields). */
void func_000B2C2C(void *arg0, s32 arg1, s32 arg2) {
    extern int func_000B2C2C();
    extern int func_000B7964();
    extern int func_000BAA60();
    if ((*(unsigned short *)((char *)arg0 + 0x2)) != arg1) {
        func_000BAA60((s32) arg0, arg1, arg2);
        return;
    }
    func_000B7964((s32) arg0, arg1, arg2);
}
...
extern int func_000ACAC8();
/* func_000B763C — 15 words. MATCH 100% (shape: m2c asm-fields). */
void func_000B763C(void *arg0, s32 arg1, s32 arg2) {
    extern int func_000ACAC8();
    extern int func_000B3CEC();
    extern int func_000B763C();
    if ((*(unsigned short *)((char *)arg0 + 0x24)) != 0) {
        func_000ACAC8((s32) arg0, arg1, arg2, 0x21040);
        return;
    }
    func_000B3CEC((s32) arg0, arg1, arg2);
}
/* func_000B7678 — 14 words. MATCH 100% (shape: m2c asm-fields). */
void func_000B7678(void *arg0, s32 arg1, s32 arg2) {
    extern int func_000AFA60();
    extern int func_000AFF94();
    extern int func_000B7678();
    if ((*(unsigned short *)((char *)arg0 + 0x20)) != 0) {
        func_000AFA60((s32) arg0, arg1, arg2);
        return;
    }
    func_000AFF94((s32) arg0, arg1, arg2);
}
...
extern int func_000ACAC8();
/* func_000B810C — 21 words. MATCH 100% (shape: bool-fold). */
s32 func_000B810C(s32 arg0, s32 arg1, s32 arg2) {
    extern int func_00078098();
    extern int func_000ACAC8();
    extern int func_000B810C();
    if (!func_000ACAC8(arg0, arg1, arg2, 0x1040)) {
        return 0;
    }
    return (func_00078098(arg1, arg2) & 0xFFFF) != 0xFFFF;
}
...
extern int func_000ACAC8();
/* func_000BCF3C — 15 words. MATCH 100% (shape: m2c asm-fields). */
void func_000BCF3C(void *arg0, s32 arg1, s32 arg2) {
    extern int func_000BBD58();
    extern int func_000BCF3C();
    extern int func_000BD574();
    if ((*(unsigned short *)((char *)arg0 + 0x26)) == 2) {
        func_000BD574((s32) arg0, arg1, arg2);
        return;
    }
    func_000BBD58((s32) arg0, arg1, arg2);
}
...
extern int func_000ACAC8();
/* func_000BFB20 — 14 words. MATCH 100% (shape: m2c unsigned short-fields). */
void func_000BFB20(void *arg0, s32 arg1, s32 arg2) {
    extern int func_000AFF94();
    extern int func_000B95D4();
    extern int func_000BFB20();
    if ((*(unsigned short *)((char *)arg0 + 0xC)) != 0) {
        func_000B95D4((s32) arg0, arg1, arg2);
        return;
    }
    func_000AFF94((s32) arg0, arg1, arg2);
}
...
extern int func_000ACAC8();
/* func_000C1604 — 14 words. MATCH 100% (shape: m2c unsigned short-fields). */
void func_000C1604(void *arg0, s32 arg1, s32 arg2) {
    extern int func_000B51C8();
    extern int func_000C1480();
    extern int func_000C1604();
    if ((*(unsigned short *)((char *)arg0 + 0xC)) != 0) {
        func_000B51C8((s32) arg0, arg1, arg2);
        return;
    }
    func_000C1480((s32) arg0, arg1, arg2);
}
...
/* func_000C2988 — 18 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000C2988(s32 arg0) {
    extern int func_0005BA60();
    extern int func_000A49E8();
    extern int func_000C2988();
    if (func_000A49E8(arg0) != 0) {
        func_0005BA60((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x4)), 0xFB6, 2, 0);
    }
    return 1;
}
/* func_000C29D0 — 18 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000C29D0(s32 arg0) {
    extern int func_0005BA60();
    extern int func_000A49E8();
    extern int func_000C29D0();
    if (func_000A49E8(arg0) != 0) {
        func_0005BA60((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x4)), 0x1EC4, 2, 0);
    }
    return 1;
}
/* func_000C2A18 — 18 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000C2A18(s32 arg0) {
    extern int func_0005BA60();
    extern int func_000A49E8();
    extern int func_000C2A18();
    if (func_000A49E8(arg0) != 0) {
        func_0005BA60((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x4)), 0x239E, 2, 0);
    }
    return 1;
}
/* func_000C2A60 — 10 words. MATCH 100% (shape: hand). */
int func_000C2A60(void *a0) {
    extern int func_0006ECD0();
    extern int func_000C2A60();
    func_0006ECD0(*(unsigned short *)((char *)a0 + 2), *(unsigned short *)((char *)a0 + 4));
    return 1;
}
...
/* func_000C69F0 — 13 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000C69F0(s32 arg0) {
    extern int func_0006ECD0();
    extern int func_000C69F0();
    extern int func_000C7998();
    func_000C7998(arg0);
    func_0006ECD0((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x4)));
    return 1;
}
/* func_000C7998 — 17 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000C7998(s32 arg0) {
    extern int func_00074230();
    extern int func_000A48AC();
    extern int func_000C7998();
    if (func_000A48AC(arg0) == 0) {
        func_00074230((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x0)), 1, (s32) (*(unsigned short *)((char *)arg0 + 0x16)));
    }
    return 1;
}
/* func_000C7AA4 — 17 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000C7AA4(s32 arg0) {
    extern int func_000154B4();
    extern int func_000A4934();
    extern int func_000C7AA4();
    if (func_000A4934(arg0) == 0) {
        func_000154B4((s32) (*(unsigned short *)((char *)arg0 + 0x2)), 1, 1, 0);
    }
    return 1;
}
...
s32 func_000C9474(s32 arg0) {
    extern int func_00074230();
    extern int func_000A48AC();
    extern int func_000C9474();
    if (func_000A48AC(arg0) == 0) {
        func_00074230((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x0)), 1, 0);
    }
    return 1;
}
/* func_000C9794 — 23 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000C9794(s32 arg0) {
    extern int func_000154B4();
    extern int func_0005BA60();
    extern int func_000A49E8();
    extern int func_000C9794();
    if (func_000A49E8(arg0) != 0) {
        func_0005BA60((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x4)), 0xFB6, 2, 0);
    }
    func_000154B4((s32) (*(unsigned short *)((char *)arg0 + 0x2)), 1, 0, 1);
    return 1;
}
/* func_000CA0FC — 17 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000CA0FC(s32 arg0) {
    extern int func_000154B4();
    extern int func_000A4934();
    extern int func_000CA0FC();
    if (func_000A4934(arg0) == 0) {
        func_000154B4((s32) (*(unsigned short *)((char *)arg0 + 0x2)), 1, 0, 1);
    }
    return 1;
}
/* func_000CCF04 — 12 words. MATCH 100% (shape: m2c). */
void func_000CCF04(s32 arg0, s32 arg1) {
    extern int func_000C4C84();
    extern int func_000C5DD0();
    extern int func_000CCF04();
    if (arg1 != 0) {
        func_000C5DD0(arg0);
        return;
    }
    func_000C4C84(arg0, 0);
}
...
/* func_000CFB1C — 35 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000CFB1C(void *arg0) {
    extern int func_0005BA60();
    extern int func_0005BCC4();
    extern int func_000A49E8();
    extern int func_000CFB1C();
    if ((*(unsigned short *)((char *)arg0 + 0x6)) == 0x13) {
        func_0005BCC4((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x4)), (s32) (*(unsigned short *)((char *)arg0 + 0x0)), 1);
    } else {
        if (func_000A49E8((s32) arg0) != 0) {
            func_0005BA60((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x4)), 0xFB6, 2, 0);
        }
        func_0005BA60((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x4)), (s32) (*(unsigned short *)((char *)arg0 + 0x0)), 2, 0);
    }
    return 1;
}
/* func_000D0720 — 25 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000D0720(s32 arg0, s32 arg1) {
    extern int func_0005BA60();
    extern int func_000A49E8();
    extern int func_000D0720();
    extern int func_0017B444();
    if (func_0017B444(arg0, arg1) == 2) {
        if (func_000A49E8(arg0) != 0) {
            func_0005BA60((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x4)), 0xFB6, 2, 0);
        }
        (*(unsigned short *)((char *)arg0 + 0x26)) = 1;
    }
    return 1;
}
/* func_000D0DA4 — 26 words. MATCH 100% (shape: single-switch asm-fields). */
s32 func_000D0DA4(void *arg0) {
    extern int D_0034D560;
    extern int func_0005F33C();
    extern int func_000743F8();
    extern int func_000D0DA4();
    if (D_0034D560 != 1) {

        switch (D_0034D560) {
        case 0:
            func_0005F33C((s32) arg0, (s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x16)), 1);
            D_0034D560 += 1;
            return 0;
            break;
        }
...
int func_000D6970(void *a0) {
    ...
    return !func_00078AAC(*(unsigned short *)((char *)a0 + 2), *(unsigned short *)((char *)a0 + 4), 0xFB6);
}
/* func_000D69A0 — 12 words. MATCH 100% (shape: hand). */
int func_000D69A0(void *a0) {
    extern int func_00078AAC();
    extern int func_000D69A0();
    return !func_00078AAC(*(unsigned short *)((char *)a0 + 2), *(unsigned short *)((char *)a0 + 4), 0x1EC4);
}
/* func_000D69D0 — 12 words. MATCH 100% (shape: hand). */
int func_000D69D0(void *a0) {
    extern int func_00078AAC();
    extern int func_000D69D0();
    return !func_00078AAC(*(unsigned short *)((char *)a0 + 2), *(unsigned short *)((char *)a0 + 4), 0x239E);
}
...
/* func_000D6A00 — 23 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000D6A00(s32 arg0) {
    extern int func_000A4934();
    extern int func_000C21D4();
    extern int func_000D6464();
    extern int func_000D6A00();
    if ((func_000A4934(arg0) == 0) && (func_000D6464((s32) (*(unsigned short *)((char *)arg0 + 0x2)), func_000C21D4(arg0), (s32) (*(unsigned short *)((char *)arg0 + 0x16)), 0) == 0)) {
        return 0;
    }
    return 1;
}
/* func_000D6AE8 — 29 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000D6AE8(s32 arg0) {
    extern int func_000A4934();
    extern int func_000C2284();
    extern int func_000D6684();
    extern int func_000D6AE8();
    s32 temp_s0;

    if (func_000A4934(arg0) == 0) {
        temp_s0 = func_000C2284(arg0);
        if (func_000D6684((*(unsigned short *)((char *)arg0 + 0x2)) ^ (*(unsigned short *)((char *)arg0 + 0xA)), (s32) (*(unsigned short *)((char *)arg0 + 0x16)), 0, 0) < temp_s0) {
            return 0;
        }
    }
    return 1;
}
/* func_000D74FC — 19 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000D74FC(void *arg0) {
    extern int func_000D74FC();
    extern int func_00152710();
    extern int func_00171004();
    s32 temp_s0;

    temp_s0 = (*(unsigned short *)((char *)arg0 + 0x2)) ^ (*(unsigned short *)((char *)arg0 + 0xA));
    return func_00171004(temp_s0, (s32) (*(unsigned short *)((char *)arg0 + 0x0)), func_00152710((s32) arg0)) != 0;
}
/* func_000D75E8 — 16 words. MATCH 100% (shape: bool-fold asm-fields). */
s32 func_000D75E8(s32 arg0) {
    extern int func_000A41B4();
    extern int func_000D75E8();
    extern int func_000FF2B4();
    s32 temp_v0;

    temp_v0 = func_000FF2B4(arg0);
    if (!temp_v0) {
        return 0;
    }
    return func_000A41B4((*(unsigned short *)((char *)arg0 + 0x2)) ^ (*(unsigned short *)((char *)arg0 + 0xA)), temp_v0);
}
...
/* func_000D8528 — 13 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000D8528(void *arg0) {
    extern int func_000820D8();
    extern int func_000D8528();
    return func_000820D8(1 - (*(unsigned short *)((char *)arg0 + 0x2)), 0xB, 0xE) >= 6;
}
/* func_000D86B4 — 18 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000D86B4(s32 arg0) {
    extern int func_0008BDA0();
    extern int func_000A4808();
    extern int func_000D86B4();
    if ((func_000A4808(arg0) == 0) && (func_0008BDA0((s32) (*(unsigned short *)((char *)arg0 + 0x2))) != 0)) {
        return 0;
    }
    return 1;
}
/* func_000D98EC — 13 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000D98EC(void *arg0) {
    extern int func_0008E6C4();
...
s32 func_000DAD78(void *arg0) {
    ...
    temp_a1 = (*(unsigned char *)((char *)arg0 + 0x31));
    if (((*(unsigned short *)((char *)arg0 + 0x2)) == ((u32) (temp_a1 << 0x1E) >> 0x1F)) && ((*(unsigned short *)((char *)arg0 + 0x4)) == ((u32) (temp_a1 << 0x1A) >> 0x1C))) {
        return 0;
    }
    return 1;
}
...
/* func_000DAFD4 — 10 words. MATCH 100% (shape: hand). */
int func_000DAFD4(void *a0) {
    extern int func_0008CFCC();
    extern int func_000DAFD4();
    return func_0008CFCC(1 - *(unsigned short *)((char *)a0 + 2)) != 0;
}
...
int func_000DD5BC(void *a0) {
    ...
    extern int func_000DD5BC();
    return func_00096754(*(unsigned short *)((char *)a0 + 2)) > 0;
}
/* func_000DD5DC — 8 words. MATCH 100% (shape: hand). */
int func_000DD5DC(void *a0) {
    extern int func_0008CFCC();
    extern int func_000DD5DC();
    return func_0008CFCC(*(unsigned short *)((char *)a0 + 2)) != 0;
}
/* func_000DD9EC — 22 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000DD9EC(s32 arg0) {
    extern int func_000A4934();
    extern int func_000D6628();
    extern int func_000DD9EC();
    if ((func_000A4934(arg0) == 0) && (func_000D6628((s32) (*(unsigned short *)((char *)arg0 + 0x2)), 5, (s32) (*(unsigned short *)((char *)arg0 + 0x16)), 0, 0) == 0)) {
        return 0;
    }
    return 1;
}
/* func_000DDD60 — 9 words. MATCH 100% (shape: hand). */
int func_000DDD60(void) {
    extern int func_000D6970();
    extern int func_000DDD60();
    return !func_000D6970();
}
/* func_000DDD84 — 9 words. MATCH 100% (shape: hand). */
int func_000DDD84(void *a0) {
    extern int func_0008BDA0();
    extern int func_000DDD84();
    return func_0008BDA0(*(unsigned short *)((char *)a0 + 2)) == 1;
}
...
int func_000DEAA4(void) {
    extern int func_000A4934();
    extern int func_000DEAA4();
    return !func_000A4934();
}
...
/* func_000DEE7C — 22 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000DEE7C(s32 arg0) {
    extern int func_000A4934();
    extern int func_000D664C();
    extern int func_000DEE7C();
    if ((func_000A4934(arg0) == 0) && (func_000D664C((s32) (*(unsigned short *)((char *)arg0 + 0x2)), 1, (s32) (*(unsigned short *)((char *)arg0 + 0x16)), 1, 0) == 0)) {
        return 0;
    }
    return 1;
}
...
s32 func_000DF648(s32 arg0) {
    ...
    extern int func_000A4808();
    extern int func_000DF648();
    if ((func_000A4808(arg0) == 0) && (func_0008ACC8((s32) (*(unsigned short *)((char *)arg0 + 0x2)), 0xFC9) == 0)) {
        return 0;
    }
    return 1;
}
...
int func_000E0024(void *a0) {
    extern int func_00094970();
    extern int func_000E0024();
    return func_00094970(*(unsigned short *)((char *)a0 + 2)) > 0;
}
/* func_000E0940 — 16 words. MATCH 100% (shape: bool-fold asm-fields). */
s32 func_000E0940(s32 arg0) {
    extern int func_0008B544();
    extern int func_000A4808();
    extern int func_000E0940();
    if (!func_000A4808(arg0)) {
...
int func_000E13C4(void *a0) {
    extern int func_000A2470();
    extern int func_000E13C4();
    return func_000A2470(*(unsigned short *)((char *)a0 + 2)) != 0;
}
/* func_000E04F0 — 5 words. MATCH 100% (shape: hand). */
extern int func_00078D2C();
/* func_000DFC60 — 9 words. MATCH 100% (shape: hand). */
int func_000DFC60(void *a0) {
    extern int func_0008E8A4();
    extern int func_000DFC60();
    return func_0008E8A4(*(unsigned short *)((char *)a0 + 2)) >= 0;
}
/* func_000DFE40 — 12 words. MATCH 100% (shape: hand). */
int func_000DFE40(void *a0) {
    extern int func_00171004();
    extern int func_000DFE40();
    return !(func_00171004(*(unsigned short *)((char *)a0 + 2), *(unsigned short *)a0, 0) < 2);
}
/* func_000DFA2C — 10 words. MATCH 100% (shape: hand). */
int func_000DFA2C(void *a0) {
    extern int func_0008E4A4();
    extern int func_000DFA2C();
    return func_0008E4A4(*(unsigned short *)((char *)a0 + 2), -1) >= 2;
}
/* func_000E0F40 — 10 words. MATCH 100% (shape: hand). */
int func_000E0F40(void *a0) {
    extern int func_0008BDA0();
    extern int func_000E0F40();
    return func_0008BDA0(1 - *(unsigned short *)((char *)a0 + 2)) != 0;
}
/* func_000E12F0 — 10 words. MATCH 100% (shape: hand). */
int func_000E12F0(void *a0) {
    extern int func_00078AAC();
    extern int func_000E12F0();
    return func_00078AAC(*(unsigned short *)((char *)a0 + 2), 0xB, 0x1846) != 0;
}
...
/* func_000E14B0 — 18 words. MATCH 100% (shape: guarded-call-lhu). */
typedef unsigned short u16;
extern int func_000D6844();
extern int func_000D79D4();
int func_000E14B0(u16 *p, int arg1) {
...
/* func_000E24F0 — 8 words. MATCH 100% (shape: hand). */
int func_000E24F0(void *a0) {
    extern int func_000A3DD8();
...
s32 func_000E350C(s32 arg0) {
    extern int func_0008218C();
    extern int func_000A4934();
    extern int func_000C2364();
    extern int func_000E350C();
    s32 temp_s0;

    temp_s0 = func_000C2364(arg0);
    if (!func_000A4934(arg0)) {
        return func_0008218C((s32) (*(unsigned short *)((char *)arg0 + 0x2)), 0) >= temp_s0;
    }
    return 1;
}
...
int func_000E50D4(void *a0) {
    extern int func_0008B7D0();
    extern int func_000E50D4();
    return func_0008B7D0(*(unsigned short *)((char *)a0 + 2), 1) > 0;
}
/* func_000E3E18 — 13 words. MATCH 100% (shape: hand). */
int func_000E3E18(void *a0) {
    extern int func_00078C8C();
    extern int func_000E3E18();
    return !func_00078C8C(*(unsigned short *)((char *)a0 + 2), 0xB, *(unsigned short *)a0, 2);
}
/* func_000E3F04 — 13 words. MATCH 100% (shape: hand). */
int func_000E3F04(void *a0) {
    extern int func_00078BE8();
    extern int func_000E3F04();
    return !func_00078BE8(*(unsigned short *)((char *)a0 + 2), 0xB, *(unsigned short *)a0, *(unsigned short *)((char *)a0 + 0x16));
}
...
int func_000E5730(void *a0) {
    extern int func_0008EACC();
    extern int func_000E5730();
    return func_0008EACC(*(unsigned short *)((char *)a0 + 2)) > 0;
}
...
/* func_000E55A8 — 9 words. MATCH 100% (shape: hand). */
int func_000E55A8(int a0) {
    extern int func_0017BB0C();
    extern int func_000E55A8();
    return func_0017BB0C(a0, (int)&func_000AF2C8) > 0;
}
/* func_000E5804 — 9 words. MATCH 100% (shape: hand). */
int func_000E5804(int a0) {
    extern int func_0017BB0C();
    extern int func_000E5804();
    return func_0017BB0C(a0, (int)&func_000B15CC) > 0;
}
/* func_000E5750 — 6 words. MATCH 100% (shape: hand). */
int func_000E5750(void *a0) {
    extern int D_00351714;
...
s32 func_000E6F4C(void *arg0) {
    extern int func_000E6F4C();
    extern int func_00171004();
    if ((*(unsigned short *)((char *)arg0 + 0x6)) == 7) {
...
/* func_000E7AFC — 8 words. MATCH 100% (shape: hand). */
int func_000E7AFC(void *a0) {
    extern int func_00096754();
...
s32 func_000E7ED0(s32 arg0, s32 arg1) {
    ...
    extern int func_000C2284();
    extern int func_000D664C();
    extern int func_000E4A14();
    extern int func_000E7ED0();
    if ((func_000A4934(arg0) == 0) && (func_000D664C((s32) (*(unsigned short *)((char *)arg0 + 0x2)), func_000C2284(arg0), (s32) (*(unsigned short *)((char *)arg0 + 0x16)), 0, 0) == 0)) {
        return 0;
    }
    return func_000E4A14(arg0, arg1);
}
/* func_000E7FE4 — 11 words. MATCH 100% (shape: hand). */
int func_000E7FE4(unsigned short *a0) {
    extern char D_0034E66C[];
    int idx = a0[1] & 1;
    int *p = (int *)(D_0034E66C + idx * 0xB3C);
    return *p != 0;
}
/* func_000E81C0 — 9 words. MATCH 100% (shape: hand). */
int func_000E81C0(void *a0) {
    extern int func_000D6844();
...
int func_000E828C(int a0) {
    extern int func_0017BB0C();
    extern int func_000AFF94();
    extern int func_000E828C();
    return func_0017BB0C(a0, (int)&func_000AFF94) > 0;
}
...
/* func_000E8A80 — 5 words. MATCH 100% (shape: hand). */
int func_000E8A80(void) {
    extern int D_0034C6D0;
    extern int func_000E8A80();
    return !D_0034C6D0;
}
/* func_000E98F0 — 9 words. MATCH 100% (shape: hand). */
int func_000E98F0(void *a0) {
...
int func_000EA160(void *a0) {
    extern int func_0008ACC8();
    extern int func_000EA160();
    return func_0008ACC8(*(unsigned short *)((char *)a0 + 2), 0x1A1A) > 0;
}
...
/* func_000EA184 — 25 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000EA184(void *arg0) {
    extern int ehsys_93517477();
    extern int func_0008C29C();
    extern int func_000EA184();
    extern int func_0017B9C4();
    s32 temp_v0;

    temp_v0 = func_0008C29C((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) ehsys_93517477);
    if ((temp_v0 != 0) && (func_0017B9C4((s32) arg0) >= temp_v0)) {
        return 2;
    }
    return 0;
}
...
/* func_000EB1A4 — 12 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000EB1A4(void *arg0) {
    extern int func_00077E80();
    extern int func_000EB1A4();
    return (func_00077E80((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x4))) & 0xFFFF) == 0xFFFF;
}
/* func_000EC114 — 18 words. MATCH 100% (shape: bool-fold asm-fields). */
s32 func_000EC114(s32 arg0) {
    extern int func_0008BDA0();
    extern int func_000A4808();
    extern int func_000EC114();
    if (!func_000A4808(arg0)) {
        return func_0008BDA0(1 - (*(unsigned short *)((char *)arg0 + 0x2))) == 5;
    }
    return 1;
}
/* func_000EC5A8 — 18 words. MATCH 100% (shape: bool-fold asm-fields). */
s32 func_000EC5A8(s32 arg0) {
    extern int func_0008E7EC();
    extern int func_000A4808();
    extern int func_000EC5A8();
    if (!func_000A4808(arg0)) {
        return func_0008E7EC(1 - (*(unsigned short *)((char *)arg0 + 0x2))) == 5;
    }
    return 0;
}
...
int func_000ECF80(int a0) {
    extern int func_0017BB0C();
    extern int func_000ECF80();
    return func_0017BB0C(a0, (int)&func_000BCDC8) != 0;
}
...
s32 func_000EDB20(s32 arg0) {
    extern int func_0008E7EC();
    extern int func_000A4808();
    extern int func_000EDB20();
    if (!func_000A4808(arg0)) {
        return func_0008E7EC(1 - (*(unsigned short *)((char *)arg0 + 0x2))) >= 3;
    }
    return 1;
}
/* func_000EDB68 — 12 words. MATCH 100% (shape: hand). */
int func_000EDB68(void *a0) {
    extern int func_0008AB14();
    extern int func_000EDB68();
    return !func_0008AB14(*(unsigned short *)((char *)a0 + 2), *(unsigned short *)a0, *(unsigned short *)((char *)a0 + 4));
}
...
/* func_000EF2C0 — 18 words. MATCH 100% (shape: guarded-call-lhu). */
typedef unsigned short u16;
extern int func_000D6800();
extern int func_000D7714();
int func_000EF2C0(u16 *p, int arg1) {

    return func_000D6800(p, p[1]) ? func_000D7714(p, arg1) : 0;
}
/* func_000EF844 — 14 words. MATCH 100% (shape: m2c). */
s32 func_000EF844(s32 arg0) {
    extern int D_0034D56C;
    extern int func_000EA4D4();
    extern int func_000EF844();
    if (D_0034D56C == 0xB) {
        return 0;
    }
...
s32 func_000F0500(s32 arg0, s32 arg1) {
    ...
    extern int func_000A41B4();
    extern int func_000ED214();
    extern int func_000F0500();
    if ((func_000ED214(arg0, arg1) != 0) && (func_000892D4(arg1, 1) == 0) && (func_000A41B4((s32) (*(unsigned short *)((char *)arg1 + 0x2)), 1) != 0)) {
        return 2;
    }
    return (*(unsigned short *)((char *)arg0 + 0x8)) == 0;
}
...
s32 func_000F18FC(s32 arg0) {
    ...
    extern int func_0008AE40();
    extern int func_000A4808();
    extern int func_000F18FC();
    if ((func_000A4808(arg0) == 0) && (func_0008AE40((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) ehsys_1738DF69) == 0)) {
        return 0;
    }
    return 1;
}
/* func_000F1BD8 — 8 words. MATCH 100% (shape: hand). */
int func_000F1BD8(void *a0) {
    extern int func_000A36E8();
    extern int func_000F1BD8();
    return func_000A36E8(*(unsigned short *)((char *)a0 + 0x16)) != 0;
}
/* func_000F1AE8 — 12 words. MATCH 100% (shape: hand). */
int func_000F1AE8(void *a0) {
    extern int func_0008B46C();
    extern int func_000F1AE8();
    return !func_0008B46C(*(unsigned short *)((char *)a0 + 2), 0x15, *(unsigned short *)((char *)a0 + 4));
}
...
/* func_000F3338 — 9 words. MATCH 100% (shape: hand). */
int func_000F3338(void *a0) {
    extern int func_0008B544();
    extern int func_000F3338();
    return func_0008B544(*(unsigned short *)((char *)a0 + 2), 0x15) != 0;
}
/* func_000F3844 — 6 words. MATCH 100% (shape: hand). */
int func_000F3844(void) {
    extern int D_0034FCD8;
    extern int func_000F3844();
    return !(D_0034FCD8 & 1);
}
/* func_000F3B6C — 10 words. MATCH 100% (shape: hand). */
int func_000F3B6C(void *a0) {
    extern int func_0008BE60();
    extern int ehsys_BD86E5F9();
...
int func_000F4394(int a0) {
    extern int func_0017BB0C();
    extern int func_000F4394();
    return func_0017BB0C(a0, (int)&func_000AF2E0) != 0;
}
/* func_000F44FC — 23 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000F44FC(s32 arg0) {
    extern int func_000A4934();
    extern int func_000F44FC();
    extern int func_00152710();
    extern int func_00171004();
    if ((func_000A4934(arg0) == 0) && (func_00171004((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x0)), func_00152710(arg0)) < 2)) {
        return 0;
    }
    return 1;
}
...
int func_000F4F30(void *a0) {
    ...
    extern int func_000F4F30();
    return func_0008BE60(*(unsigned short *)((char *)a0 + 2), (int)&func_002EF364) > 0;
}
...
/* func_000F5058 — 18 words. MATCH 100% (shape: guarded-call-lhu). */
typedef unsigned short u16;
extern int func_000D6844();
extern int func_000DE4E8();
int func_000F5058(u16 *p, int arg1) {

    return func_000D6844(p, p[1]) ? func_000DE4E8(p, arg1) : 0;
}
...
s32 func_000F5814(void *arg0) {
    ...
    extern int func_000F5814();
    if (!D_0034C6D0) {
        return func_00035D28((s32) (*(unsigned short *)((char *)arg0 + 0x2)), (s32) (*(unsigned short *)((char *)arg0 + 0x4))) != 0;
    }
    return 0;
}
/* func_000F5AC4 — 9 words. MATCH 100% (shape: hand). */
int func_000F5AC4(int a0) {
    extern int func_0017BB0C();
...
s32 func_000F6150(void *arg0) {
    extern int func_000E2908();
    extern int func_000F6150();
    if ((s32) (*(unsigned short *)((char *)arg0 + 0x4)) < 5) {
        return 0;
    }
    return func_000E2908((s32) arg0);
}
/* func_000F6C54 — 16 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000F6C54(void *arg0) {
    extern int D_0034D57C;
    extern int func_000F6C54();
    extern int func_0017BF20();
    if ((D_0034D57C == 0) && (func_0017BF20((s32) arg0, (s32) (*(unsigned short *)((char *)arg0 + 0x2))) != 0)) {
        return 0;
    }
    return 2;
}
/* func_000F6D7C — 9 words. MATCH 100% (shape: hand). */
int func_000F6D7C(void *a0) {
    extern int func_00094AA4();
    extern int func_000F6D7C();
    return func_00094AA4(*(unsigned short *)((char *)a0 + 2), 0xD) > 0;
}
/* func_000F6FAC — 25 words. MATCH 100% (shape: m2c asm-fields). */
s32 func_000F6FAC(void *arg0) {
    extern int func_00078C8C();
    extern int func_000D7144();
    extern int func_000F6FAC();
    if ((*(unsigned short *)((char *)arg0 + 0x8)) == 0) {
        if (func_00078C8C((s32) (*(unsigned short *)((char *)arg0 + 0x2)), 0xB, (s32) (*(unsigned short *)((char *)arg0 + 0x0)), 2) == 0) {
            return 0;
        }
        goto block_5;
    }
    if (func_000D7144((s32) arg0) == 0) {
        return 0;
    }
block_5:
    return 1;
...
int func_000FA4EC(void *a0) {
    extern int func_000779C8();
    extern int func_000FA4EC();
    return func_000779C8(*(unsigned short *)((char *)a0 + 2), *(unsigned short *)((char *)a0 + 4)) != 0;
}
/* func_000FADEC — 15 words. MATCH 100% (shape: bool-fold unsigned short-fields). */
s32 func_000FADEC(s32 arg0, s32 arg1) {
    extern int func_000DAAD0();
    extern int func_000FADEC();
    if (!func_000DAAD0(arg0, arg1)) {
        return (*(unsigned short *)((char *)arg0 + 0x8)) == 0;
    }
    return 2;
}
...
int func_000FC068(void *a0) {
    extern int func_00092B18();
    extern int func_000FC068();
    return func_00092B18(a0, *(unsigned short *)((char *)a0 + 2), *(unsigned short *)((char *)a0 + 4), 0) != 0;
}
...
int func_00106664(void *a0) {
    ...
    extern int func_00106664();
    func_000743C8(*(unsigned short *)((char *)a0 + 2));
    return 0;
}
/* func_0010693C — 10 words. MATCH 100% (shape: hand). */
int func_0010693C(void *a0) {
    extern int func_0005F33C();
...
int func_00108468(void *a0) {
    extern int func_00101224();
    extern int func_00108468();
    func_00101224(a0, 0x17, *(unsigned short *)a0);
    return 0;
}
/* func_00108A40 — 9 words. MATCH 100% (shape: hand). */
int func_00108A40(void *a0) {
    extern int func_00101224();
    extern int func_00108A40();
    func_00101224(a0, 0x16, *(unsigned short *)a0);
    return 0;
}
/* func_00101224 — 2 words. MATCH 100% (shape: hand). */
extern int func_0010122C();
/* func_00105A88 — 10 words. MATCH 100% (shape: hand). */
int func_00105A88(void *a0) {
    extern int func_0010122C();
    extern int func_00105A88();
    func_0010122C(a0, 0x17, *(unsigned short *)((char *)a0 + 0x24), 0);
    return 0;
}
...
int func_00110FB0(void *a0) {
    extern int func_00101224();
    extern int func_00110FB0();
    func_00101224(a0, 1, *(unsigned short *)((char *)a0 + 2));
    return 0;
}
...
int func_0011674C(void *a0) {
    ...
    extern int func_0011674C();
    func_00101398(a0, 5, *(unsigned short *)((char *)a0 + 2));
    return 0;
}
...
/* func_001257D4 — 17 words. MATCH 100% (shape: guarded-call). */
extern int func_000A49E8();
extern int func_000FF294();
...
int func_00128930(void *a0) {
    extern int func_00060930();
    extern int func_00128930();
    func_00060930(*(unsigned short *)((char *)a0 + 2), 0x1F);
    return 0;
}
...
/* func_0012BB70 — 4 words. MATCH 100% (shape: hand). */
int func_0012BB70(void *a0, unsigned short *a1) {
    a1[0xD] = 1;
    return 0;
}
...
/* func_0012E9A8 — 17 words. MATCH 100% (shape: guarded-call). */
extern int func_000A49E8();
extern int func_000FEF9C();
int func_0012E9A8(int arg0, int arg1) {

    return func_000A49E8(arg0) ? func_000FEF9C(arg0, arg1) : 0;
}
...
/* func_0013DCF4 — 9 words. MATCH 100% (shape: hand). */
int func_0013DCF4(void *a0) {
    extern int func_00073874();
    extern int func_0013DCF4();
    func_00073874(a0, *(unsigned short *)((char *)a0 + 2), 5);
    return 0;
}
/* func_00140338 — 17 words. MATCH 100% (shape: guarded-call). */
extern int func_0017B9C4();
extern int func_001024B4();
int func_00140338(int arg0, int arg1) {
...
int func_00149F60(int a0) {
    extern int func_00101224();
    extern int func_00149F60();
    func_00101224(a0, 4, 0);
    return 0;
}
...
/* func_00162D30 — 14 words. MATCH 100% (shape: hand). */
int func_00162D30(int a0, int a1, int a2, int a3, unsigned short *t0, int *t1) {
    extern int ehsys_CC7A2A21();
    extern int func_00162D30();
    return *t1 == ehsys_CC7A2A21(*t0 & 0x3FFF);
}
/* func_00162D68 — 14 words. MATCH 100% (shape: hand). */
int func_00162D68(int a0, int a1, int a2, int a3, unsigned short *t0, int *t1) {
    extern int ehsys_FCB00A02();
    extern int func_00162D68();
    return *t1 == ehsys_FCB00A02(*t0 & 0x3FFF);
}
/* func_00162DD0 — 4 words. MATCH 100% (shape: hand). */
int func_00162DD0(int a0, int a1, int a2, int a3, unsigned short *t0, int *t1) {
    extern int ehsys_D83FB4E8();
    extern int func_00162DD0();
    return ehsys_D83FB4E8(*t0 & 0x3FFF, *t1);
}
/* func_00162DE0 — 14 words. MATCH 100% (shape: hand). */
int func_00162DE0(int a0, int a1, int a2, int a3, unsigned short *t0, int *t1) {
    extern int ehsys_760919BF();
    extern int func_00162DE0();
    return !(*t1 < ehsys_760919BF(*t0 & 0x3FFF));
}
/* func_00162E60 — 14 words. MATCH 100% (shape: hand). */
int func_00162E60(int a0, int a1, int a2, int a3, unsigned short *t0, int *t1) {
    extern int ehsys_760919BF();
    extern int func_00162E60();
    return *t1 == ehsys_760919BF(*t0 & 0x3FFF);
}
/* func_00162E98 — 14 words. MATCH 100% (shape: hand). */
int func_00162E98(int a0, int a1, int a2, int a3, unsigned short *t0, int *t1) {
    extern int ehsys_249F5AD0();
    extern int func_00162E98();
    return !(*t1 < ehsys_249F5AD0(*t0 & 0x3FFF));
}
/* func_00162ED0 — 14 words. MATCH 100% (shape: hand). */
int func_00162ED0(int a0, int a1, int a2, int a3, unsigned short *t0, int *t1) {
    extern int ehsys_249F5AD0();
    extern int func_00162ED0();
    return *t1 == ehsys_249F5AD0(*t0 & 0x3FFF);
}
/* func_00162F48 — 10 words. MATCH 100% (shape: hand). */
int func_00162F48(int a0, int a1, int a2, int a3, void *t0) {
    extern int ehsys_80896C1D();
    extern int func_00162F48();
    return !ehsys_80896C1D(*(unsigned short *)t0 & 0x3FFF);
}
...
/* func_00164640 — 10 words. MATCH 100% (shape: hand). */
int func_00164640(int a0, int a1, int a2, int a3, void *t0) {
    extern int ehsys_95E50EFA();
    extern int func_00164640();
    return !ehsys_95E50EFA(*(unsigned short *)t0 & 0x3FFF);
}
...
/* func_00168490 — 10 words. MATCH 100% (shape: hand). */
int func_00168490(int a0, int a1, int a2, int a3, void *t0) {
    extern int func_0007FAAC();
    extern int func_00168490();
    return !func_0007FAAC(*(unsigned short *)t0 & 0x3FFF);
}
...
/* func_001686CC — 14 words. MATCH 100% (shape: hand). */
int func_001686CC(int a0, int a1, int a2, int a3, unsigned short *t0, int *t1) {
    extern int ehsys_1DA3918E();
    extern int func_001686CC();
    return *t1 == ehsys_1DA3918E(*t0 & 0x3FFF);
}
...
/* func_0016D6E8 — 6 words. MATCH 100% (shape: hand). */
int func_0016D6E8(int a0, int a1, int a2, int a3, void *t0) {
    extern int func_0016D6E8();
    return !(((unsigned int)(*(unsigned char *)((char *)t0 + 2)) << 29) >> 31);
}
...
/* func_00163128 — 14 words. MATCH 100% (shape: hand). */
int func_00163128(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162DD0();
    extern int func_00163128();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x20);
}
/* func_00163630 — 14 words. MATCH 100% (shape: hand). */
int func_00163630(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162DD0();
    extern int func_00163630();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x2);
}
/* func_001658F0 — 14 words. MATCH 100% (shape: hand). */
int func_001658F0(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162D68();
    extern int func_001658F0();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162D68), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x2);
}
/* func_00168A60 — 14 words. MATCH 100% (shape: hand). */
int func_00168A60(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162DD0();
    extern int func_00168A60();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_00169510 — 14 words. MATCH 100% (shape: hand). */
int func_00169510(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162DE0();
    extern int func_00169510();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162DE0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_0016A4E0 — 14 words. MATCH 100% (shape: hand). */
int func_0016A4E0(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162DD0();
    extern int func_0016A4E0();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x11);
}
/* func_0016C1D0 — 14 words. MATCH 100% (shape: hand). */
int func_0016C1D0(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162DD0();
    extern int func_0016C1D0();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x10);
}
/* func_0016C57C — 14 words. MATCH 100% (shape: hand). */
int func_0016C57C(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162DD0();
    extern int func_0016C57C();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x8);
}
/* func_0016CF64 — 14 words. MATCH 100% (shape: hand). */
int func_0016CF64(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162B50();
    extern int func_0016CF64();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162B50), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x20);
}
/* func_0016D038 — 14 words. MATCH 100% (shape: hand). */
int func_0016D038(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162B50();
    extern int func_0016D038();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162B50), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x2);
}
/* func_0016D554 — 14 words. MATCH 100% (shape: hand). */
int func_0016D554(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162B50();
    extern int func_0016D554();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162B50), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x10);
}
/* func_0016DE90 — 14 words. MATCH 100% (shape: hand). */
int func_0016DE90(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162D68();
    extern int func_0016DE90();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162D68), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x11);
}
/* func_0016E744 — 14 words. MATCH 100% (shape: hand). */
int func_0016E744(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162DE0();
    extern int func_0016E744();
    int local = *(short *)((char *)a0 + 0x2);
...
int func_0016F040(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162DE0();
    extern int func_0016F040();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162DE0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x2);
}
/* func_0016F2BC — 14 words. MATCH 100% (shape: hand). */
int func_0016F2BC(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162DD0();
...
int func_0016F574(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_00161DF0();
    extern int func_00162E18();
    extern int func_0016F574();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161DF0(a1, (*(unsigned short *)((char *)(a0) + 0)), a2, ((int)&func_00162E18), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x11);
}
...
/* func_00163434 — 12 words. MATCH 100% (shape: hand). */
int func_00163434(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_0016331C();
    extern int func_00163434();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_0016331C), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_0016410C — 12 words. MATCH 100% (shape: hand). */
int func_0016410C(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162B50();
    extern int func_0016410C();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162B50), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x8);
}
/* func_001642A8 — 12 words. MATCH 100% (shape: hand). */
int func_001642A8(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162DD0();
    extern int func_001642A8();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x8);
}
/* func_0016430C — 12 words. MATCH 100% (shape: hand). */
int func_0016430C(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162B50();
    extern int func_0016430C();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162B50), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_001645C4 — 12 words. MATCH 100% (shape: hand). */
int func_001645C4(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162DA0();
    extern int func_001645C4();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DA0), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x20);
}
/* func_001653D8 — 12 words. MATCH 100% (shape: hand). */
int func_001653D8(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00165380();
    extern int func_001653D8();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00165380), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x8);
}
/* func_00165870 — 12 words. MATCH 100% (shape: hand). */
int func_00165870(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162DA0();
    extern int func_00165870();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DA0), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_00165D6C — 12 words. MATCH 100% (shape: hand). */
int func_00165D6C(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00165CD0();
    extern int func_00165D6C();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00165CD0), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_00165DA8 — 12 words. MATCH 100% (shape: hand). */
int func_00165DA8(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162DD0();
    extern int func_00165DA8();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_00166CBC — 12 words. MATCH 100% (shape: hand). */
int func_00166CBC(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162D30();
    extern int func_00166CBC();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162D30), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x8);
}
/* func_00166E80 — 12 words. MATCH 100% (shape: hand). */
int func_00166E80(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00166E00();
    extern int func_00166E80();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00166E00), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x10000);
}
/* func_00167100 — 12 words. MATCH 100% (shape: hand). */
int func_00167100(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162DA0();
    extern int func_00167100();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DA0), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x8);
}
/* func_001674A8 — 12 words. MATCH 100% (shape: hand). */
int func_001674A8(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162DD0();
    extern int func_001674A8();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x800);
}
/* func_00168154 — 12 words. MATCH 100% (shape: hand). */
int func_00168154(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162DD0();
    extern int func_00168154();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x1008);
}
/* func_00168FF4 — 12 words. MATCH 100% (shape: hand). */
int func_00168FF4(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162DD0();
    extern int func_00168FF4();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x108);
}
/* func_001696FC — 12 words. MATCH 100% (shape: hand). */
int func_001696FC(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162ED0();
    extern int func_001696FC();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162ED0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_001698BC — 12 words. MATCH 100% (shape: hand). */
int func_001698BC(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162DD0();
    extern int func_001698BC();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x10000);
}
/* func_001698FC — 12 words. MATCH 100% (shape: hand). */
int func_001698FC(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162DA0();
    extern int func_001698FC();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DA0), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x10000);
}
/* func_0016A054 — 12 words. MATCH 100% (shape: hand). */
int func_0016A054(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162D68();
    extern int func_0016A054();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162D68), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x8);
}
/* func_0016AF40 — 12 words. MATCH 100% (shape: hand). */
int func_0016AF40(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162DD0();
    extern int func_0016AF40();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x1000);
}
/* func_0016B350 — 12 words. MATCH 100% (shape: hand). */
int func_0016B350(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162D68();
    extern int func_0016B350();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162D68), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_0016B4F4 — 12 words. MATCH 100% (shape: hand). */
int func_0016B4F4(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162D68();
    extern int func_0016B4F4();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162D68), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x10000);
}
/* func_0016BF20 — 12 words. MATCH 100% (shape: hand). */
int func_0016BF20(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162E60();
    extern int func_0016BF20();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162E60), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x8);
}
/* func_0016C210 — 12 words. MATCH 100% (shape: hand). */
int func_0016C210(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162B50();
    extern int func_0016C210();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162B50), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x10000);
}
/* func_0016C424 — 12 words. MATCH 100% (shape: hand). */
int func_0016C424(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162E98();
    extern int func_0016C424();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162E98), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x4);
}
/* func_0016CD2C — 12 words. MATCH 100% (shape: hand). */
int func_0016CD2C(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162B50();
    extern int func_0016CD2C();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162B50), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x20000);
}
/* func_0016CD98 — 12 words. MATCH 100% (shape: hand). */
int func_0016CD98(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_0016CD6C();
    extern int func_0016CD98();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_0016CD6C), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x9);
}
/* func_0016CFFC — 12 words. MATCH 100% (shape: hand). */
int func_0016CFFC(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_0016CFA4();
    extern int func_0016CFFC();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_0016CFA4), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x8);
}
/* func_0016D450 — 12 words. MATCH 100% (shape: hand). */
int func_0016D450(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_0016D384();
    extern int func_0016D450();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_0016D384), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x10000);
}
/* func_0016D724 — 12 words. MATCH 100% (shape: hand). */
int func_0016D724(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162ED0();
    extern int func_0016D724();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162ED0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x8);
}
/* func_0016D764 — 12 words. MATCH 100% (shape: hand). */
int func_0016D764(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162ED0();
    extern int func_0016D764();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162ED0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x10000);
}
/* func_0016E270 — 12 words. MATCH 100% (shape: hand). */
int func_0016E270(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_0016E184();
    extern int func_0016E270();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_0016E184), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x10000);
}
/* func_0016ED38 — 12 words. MATCH 100% (shape: hand). */
int func_0016ED38(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_0016ED0C();
    extern int func_0016ED38();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_0016ED0C), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_0016EE1C — 12 words. MATCH 100% (shape: hand). */
int func_0016EE1C(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162E98();
    extern int func_0016EE1C();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162E98), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_0016F158 — 12 words. MATCH 100% (shape: hand). */
int func_0016F158(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_0016F080();
    extern int func_0016F158();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_0016F080), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_0016F430 — 12 words. MATCH 100% (shape: hand). */
int func_0016F430(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_0016F404();
    extern int func_0016F430();
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_0016F404), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_0016F6B4 — 12 words. MATCH 100% (shape: hand). */
int func_0016F6B4(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00162DD0();
    extern int func_0016F6B4();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x20000);
}
/* func_0016F8FC — 12 words. MATCH 100% (shape: hand). */
int func_0016F8FC(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
...
int func_00170080(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00170028();
    extern int func_00170080();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00170028), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x8);
}
/* func_001701B4 — 12 words. MATCH 100% (shape: hand). */
int func_001701B4(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_00170148();
    extern int func_001701B4();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00170148), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_00170738 — 12 words. MATCH 100% (shape: hand). */
int func_00170738(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001621C4();
    extern int func_001706E0();
    extern int func_00170738();
    int local = *(short *)((char *)a0 + 2);
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_001706E0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x8);
}
...
/* func_00163778 — 12 words. MATCH 100% (shape: hand). */
int func_00163778(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162B50();
    extern int func_00163778();
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162B50), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0xA);
}
/* func_001637B4 — 12 words. MATCH 100% (shape: hand). */
int func_001637B4(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162DD0();
    extern int func_001637B4();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_00163818 — 12 words. MATCH 100% (shape: hand). */
int func_00163818(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162DD0();
    extern int func_00163818();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0xA);
}
/* func_0016438C — 12 words. MATCH 100% (shape: hand). */
int func_0016438C(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162E98();
    extern int func_0016438C();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162E98), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x2);
}
/* func_00164584 — 12 words. MATCH 100% (shape: hand). */
int func_00164584(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162D30();
    extern int func_00164584();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162D30), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_0016547C — 12 words. MATCH 100% (shape: hand). */
int func_0016547C(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162E98();
    extern int func_0016547C();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162E98), ((int)&local), (*(int *)((char *)(a0) + 8)), 0xA);
}
/* func_00166510 — 12 words. MATCH 100% (shape: hand). */
int func_00166510(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162D30();
    extern int func_00166510();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162D30), ((int)&local), (*(int *)((char *)(a0) + 8)), 0xA);
}
/* func_0016BB80 — 12 words. MATCH 100% (shape: hand). */
int func_0016BB80(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162DD0();
    extern int func_0016BB80();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x20);
}
/* func_0016BBC0 — 12 words. MATCH 100% (shape: hand). */
int func_0016BBC0(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162ED0();
    extern int func_0016BBC0();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162ED0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x2);
}
/* func_0016C678 — 12 words. MATCH 100% (shape: hand). */
int func_0016C678(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_0016C634();
    extern int func_0016C678();
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_0016C634), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0xA);
}
/* func_0016CCF0 — 12 words. MATCH 100% (shape: hand). */
int func_0016CCF0(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_0016CC9C();
    extern int func_0016CCF0();
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_0016CC9C), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_0016D6A8 — 12 words. MATCH 100% (shape: hand). */
int func_0016D6A8(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162DE0();
    extern int func_0016D6A8();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DE0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_0016DC40 — 12 words. MATCH 100% (shape: hand). */
int func_0016DC40(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162D68();
    extern int func_0016DC40();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162D68), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_0016DC80 — 12 words. MATCH 100% (shape: hand). */
int func_0016DC80(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162D68();
    extern int func_0016DC80();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162D68), ((int)&local), (*(int *)((char *)(a0) + 8)), 0xA);
}
/* func_0016DD20 — 12 words. MATCH 100% (shape: hand). */
int func_0016DD20(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00162D68();
    extern int func_0016DD20();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162D68), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x2);
}
/* func_0016F6F4 — 12 words. MATCH 100% (shape: hand). */
int func_0016F6F4(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00165CD0();
    extern int func_0016F6F4();
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00165CD0), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_0016FDFC — 12 words. MATCH 100% (shape: hand). */
int func_0016FDFC(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_0016FDB4();
    extern int func_0016FDFC();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_0016FDB4), ((int)&local), (*(int *)((char *)(a0) + 8)), 0xA);
}
/* func_00170108 — 12 words. MATCH 100% (shape: hand). */
int func_00170108(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_001700C0();
    extern int func_00170108();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_001700C0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_00170258 — 12 words. MATCH 100% (shape: hand). */
int func_00170258(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00170148();
    extern int func_00170258();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00170148), ((int)&local), (*(int *)((char *)(a0) + 8)), 0);
}
/* func_001702E4 — 12 words. MATCH 100% (shape: hand). */
int func_001702E4(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0016164C();
    extern int func_00170298();
    extern int func_001702E4();
    int local = *(short *)((char *)a0 + 2);
    return func_0016164C(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00170298), ((int)&local), (*(int *)((char *)(a0) + 8)), 0xA);
}
...
/* func_00183730 — 10 words. MATCH 100% (shape: hand). */
int func_00183730(int a0, int a1, int a2, int a3) {
    extern int func_0017E33C();
    extern int func_00183730();
    int buf;
    buf = 0;
    func_0017E33C(a0, a1, a2, a3, &buf, 0);
    return buf;
}
...
/* func_001A1030 — 10 words. MATCH 100% (shape: hand). */
int func_001A1030(int a0, int a1, int a2) {
    extern int func_001A1058();
    extern int func_001A1030();
    return !(func_001A1058(a0, a1, a2, 1, 0) < 5);
}
...
/* func_001A3000 — 35 words. MATCH 100% (shape: m2c). */
s32 func_001A3000(s32 arg0, int arg1, s32 arg2, s32 arg3) {
    extern int func_001A2BBC();
    extern int func_001A3000();
    extern int func_002E6434();
    extern int func_002E6718();
    s32 var_s0;
    ...
    if (arg2 != 0) {
        ...
        var_s0 = func_001A2BBC(arg0, arg1, arg2);
        if (arg3 != 0) {
            func_002E6718();
        }
    }
...
/* func_001A3204 — 35 words. MATCH 100% (shape: m2c). */
s32 func_001A3204(s32 arg0, int arg1, s32 arg2, s32 arg3) {
    extern int func_001A308C();
    extern int func_001A3204();
    extern int func_002E6434();
    extern int func_002E6718();
    s32 var_s0;
    ...
    if (arg2 != 0) {
        ...
        var_s0 = func_001A308C(arg0, arg1, arg2);
        if (arg3 != 0) {
            func_002E6718();
        }
    }
...
/* func_001A5180 — 7 words. MATCH 100% (shape: hand). */
int func_001A5180(void *a0, int a1) {
    extern int func_001A5180();
    return *((unsigned char *)a0 + a1 * 20 + 8) & 7;
}
/* func_001A51D0 — 8 words. MATCH 100% (shape: hand). */
int func_001A51D0(void *a0, int a1) {
    extern int func_001A51D0();
    return ((unsigned int)(*((unsigned char *)a0 + a1 * 20 + 0xC)) << 26) >> 28;
}
...
/* func_001FDB88 — 9 words. MATCH 100% (shape: hand). */
int func_001FDB88(void *a0) {
    extern int func_00186960();
    extern int func_001FDB88();
    return func_00186960(a0, *(unsigned short *)((char *)a0 + 2), 0) > 0;
}
...
/* func_001FE374 — 12 words. MATCH 100% (shape: hand). */
int func_001FE374(void *a0) {
    extern int func_002CC9C4();
    extern int func_001FE374();
    return !(func_002CC9C4(*(unsigned short *)((char *)a0 + 2), *(unsigned short *)a0, 0) < 0);
}
/* func_001FEBDC — 13 words. MATCH 100% (shape: hand). */
int func_001FEBDC(void *a0) {
    extern int func_00078AAC();
    extern int func_001FEBDC();
    return !func_00078AAC(1 - *(unsigned short *)((char *)a0 + 2), 0xB, *(unsigned short *)a0);
}
...
/* func_0020CAE0 — 9 words. MATCH 100% (shape: hand). */
int func_0020CAE0(void *a0) {
    extern int func_00274F34();
    extern int func_0020CAE0();
    return !(func_00274F34(*(unsigned short *)((char *)a0 + 2)) > 0);
}
...
/* func_0020E488 — 10 words. MATCH 100% (shape: hand). */
int func_0020E488(void *a0) {
    extern int func_00089E9C();
    extern int func_0020E488();
    return func_00089E9C(*(unsigned short *)((char *)a0 + 2), 0xFF8, -1) > 0;
}
...
/* func_0020F21C — 8 words. MATCH 100% (shape: hand). */
int func_0020F21C(void *a0) {
    extern int func_0008CFC4();
    extern int func_0020F21C();
    return func_0008CFC4(*(unsigned short *)((char *)a0 + 2)) > 0;
}
...
/* func_00211024 — 9 words. MATCH 100% (shape: hand). */
int func_00211024(void *a0) {
    extern int func_0008BDA0();
    extern int func_00211024();
    return !func_0008BDA0(*(unsigned short *)((char *)a0 + 2));
}
...
/* func_00212048 — 5 words. MATCH 100% (shape: hand). */
int func_00212048(void *a0) {
    extern int func_00212048();
    return (*(unsigned short *)((char *)a0 + 2) ^ *(unsigned char *)((char *)a0 + 0x30)) != 0;
}
/* func_00212EA4 — 5 words. MATCH 100% (shape: hand). */
int func_00212EA4(void) {
    extern int D_00351724;
    extern int func_00212EA4();
    return !((unsigned int)D_00351724 < 2);
}
/* func_00219EC8 — 10 words. MATCH 100% (shape: hand). */
int func_00219EC8(void *a0) {
    extern int func_00089E9C();
    extern int func_00219EC8();
    return func_00089E9C(*(unsigned short *)((char *)a0 + 2), 0x1817, -1) > 0;
}
/* func_0021B15C — 9 words. MATCH 100% (shape: hand). */
int func_0021B15C(void *a0) {
    extern int func_000967F4();
    extern int func_0021B15C();
    return func_000967F4(*(unsigned short *)((char *)a0 + 2), 5) > 0;
}
/* func_0021C168 — 10 words. MATCH 100% (shape: hand). */
int func_0021C168(void *a0) {
    extern int func_00089E9C();
    extern int func_0021C168();
    return func_00089E9C(*(unsigned short *)((char *)a0 + 2), 0xFFF, -1) > 0;
}
...
/* func_0021E008 — 10 words. MATCH 100% (shape: hand). */
int func_0021E008(void *a0) {
    extern int func_0008BDA0();
    extern int func_0021E008();
    return func_0008BDA0(1 - *(unsigned short *)((char *)a0 + 2)) > 0;
}
...
/* func_002200EC — 10 words. MATCH 100% (shape: hand). */
int func_002200EC(void *a0) {
    extern int func_0017CA90();
    extern int func_002200EC();
    return (unsigned int)(func_0017CA90(*(unsigned short *)((char *)a0 + 2), 0xA) ^ 0x175E) < 1;
}
/* func_00226134 — 9 words. MATCH 100% (shape: hand). */
int func_00226134(void *a0) {
    extern int func_0008BDA0();
    extern int func_00226134();
    return !(func_0008BDA0(*(unsigned short *)((char *)a0 + 2)) < 3);
}
...
/* func_00228198 — 10 words. MATCH 100% (shape: hand). */
int func_00228198(int a0) {
    extern int func_001FE8E4();
    extern int func_00228198();
    return func_001FE8E4(a0, 0x12C, 0) == 1;
}
...
/* func_00229EA0 — 4 words. MATCH 100% (shape: hand). */
int func_00229EA0(void *a0) {
    return (unsigned int)(*(unsigned short *)((char *)a0 + 6) ^ 3) < 1;
}
...
extern int func_00206270();
/* func_0022C230 — 34 words. MATCH 100% (shape: m2c). */
s32 func_0022C230(void *arg0) {
    extern int ehsys_146B0409();
    extern int func_00084614();
    extern int func_00094F28();
    extern int func_00096450();
    extern int func_0022C230();
    s32 temp_s0_2;
    s32 temp_s1;
    s32 temp_v0;
    s32 var_v1;
    ...
    temp_s0 = (*(int *)((char *)arg0 + 0x2));
    temp_s1 = func_00094F28(temp_s0, ehsys_146B0409);
    temp_s0_2 = func_00084614(temp_s0, ehsys_146B0409);
    temp_v0 = func_00096450(temp_s0, ehsys_146B0409);
    var_v1 = temp_s1 >= 3;
    if (var_v1 == 0) {
        var_v1_2 = temp_s0_2 != 0;
        if (var_v1_2 == 0) {
            var_v1_2 = temp_v0 != 0;
        }
        var_v1 = var_v1_2 ^ 1;
...
/* func_00246D24 — 9 words. MATCH 100% (shape: hand). */
int func_00246D24(int a0) {
    extern int func_00246798();
    extern int func_00246D24();
    return (short)func_00246798(a0, 1) > 0;
}
...
/* func_00275100 — 9 words. MATCH 100% (shape: hand). */
int func_00275100(int a0) {
    extern short D_0034BB20[];
    extern int func_00275100();
    return *(short *)((char *)D_0034BB20 + a0 * 0x1A8) < 2;
}
...
/* func_00283588 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_003231E4;
int func_00283588(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_003231E4, 0xE);
}
/* func_002836A0 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00323228;
int func_002836A0(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00323228, 0x7);
}
/* func_002836D4 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00323238;
int func_002836D4(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00323238, 0x16);
}
...
/* func_00283FC8 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00323508;
int func_00283FC8(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00323508, 0xD);
}
...
/* func_002842B0 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_003236E8;
int func_002842B0(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_003236E8, 0x1);
}
/* func_00284334 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00323780;
int func_00284334(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00323780, 0x1A);
}
/* func_00284368 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_003237B4;
int func_00284368(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_003237B4, 0x5);
}
/* func_00284420 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00323808;
int func_00284420(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00323808, 0x20);
}
...
/* func_002844BC — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00323864;
int func_002844BC(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00323864, 0x27);
}
/* func_002844F0 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_003238B4;
int func_002844F0(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_003238B4, 0x1E);
}
/* func_00284524 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_003238F0;
int func_00284524(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_003238F0, 0x6);
}
...
/* func_002845C4 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00323960;
int func_002845C4(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00323960, 0xE);
}
/* func_002845F8 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_0032397C;
int func_002845F8(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_0032397C, 0x15);
}
...
/* func_0028511C — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00323AE0;
int func_0028511C(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00323AE0, 0x21);
}
...
/* func_00285160 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00323B38;
int func_00285160(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00323B38, 0x6);
}
/* func_00285194 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00323B44;
int func_00285194(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00323B44, 0x17);
}
/* func_0028593C — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00324144;
int func_0028593C(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00324144, 0xB);
}
/* func_00285970 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_0032415C;
int func_00285970(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_0032415C, 0xF);
}
/* func_002859A4 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_0032417C;
int func_002859A4(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_0032417C, 0xE);
}
/* func_00285A1C — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_003241C4;
int func_00285A1C(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_003241C4, 0x14);
}
/* func_00285A50 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_003241EC;
int func_00285A50(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_003241EC, 0x5A);
}
/* func_00285A84 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_003242A0;
int func_00285A84(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_003242A0, 0x4);
}
/* func_00285AB8 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_003242A8;
int func_00285AB8(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_003242A8, 0x19);
}
/* func_00285B84 — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00324340;
int func_00285B84(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00324340, 0x39);
}
...
/* func_00285C5C — 13 words. MATCH 100% (shape: seh-dispatch). */
extern short func_001A3A88();
extern int func_002EED24(short, void *, int);
extern int D_00324450;
int func_00285C5C(short arg0, int arg1) {

    if (arg1) { arg0 = func_001A3A88(arg0); }
    return func_002EED24(arg0, &D_00324450, 0xB);
}
...
/* func_0028918C — 10 words. MATCH 100% (shape: hand). */
int func_0028918C(s32 a0) {
    extern int func_0003FBD4();
    extern int ehsys_747753B8();
    extern int func_0028918C();
    unsigned short v0 = *(unsigned short *)func_0003FBD4(a0);
    return ehsys_747753B8(v0 & 0x3FFF);
}
...
/* func_0028C1EC — 10 words. MATCH 100% (shape: hand). */
int func_0028C1EC(s32 a0) {
    extern int func_0003FBD4();
    extern int func_0019BCC0();
    extern int func_0028C1EC();
    unsigned short v0 = *(unsigned short *)func_0003FBD4(a0);
    return func_0019BCC0(v0 & 0x3FFF);
}
...
/* func_002AF1F0 — 21 words. MATCH 100% (shape: m2c). */
s32 func_002AF1F0(void) {
    extern void * D_0034D434;
    extern int func_00187BB0();
    extern int func_002AF1F0();
    s32 temp_v0;
    u16 temp_a0;
    void *temp_s0;

    temp_s0 = D_0034D434;
    temp_v0 = func_00187BB0();
    temp_a0 = (*(int *)((char *)temp_s0 + 0x2C));
    if ((temp_v0 < (s32) temp_a0) && ((temp_v0 + 0x2BC) >= (s32) temp_a0)) {
        return temp_v0;
    }
    return 0;
}
...
/* func_002BE2F8 — 40 words. MATCH 100% (shape: m2c). */
s32 func_002BE2F8(s32 arg0, s32 arg1) {
    extern char D_0034E660;
    extern int func_000810CC();
    extern int func_0008BDA0();
    extern int func_0009F680();
    extern int func_002BE2F8();
    s32 var_s0;

    var_s0 = func_0009F680();
    if (func_000810CC((arg1 * 0x14) + (&D_0034E660 + ((arg0 & 1) * 0xB3C)) + 0x34) == 0) {
        var_s0 += 1;
    }
    if ((var_s0 == 0) && (func_0008BDA0(arg0) == 1)) {
        var_s0 += 1;
    }
    return var_s0;
}
/* func_002CE3A0 — 8 words. MATCH 100% (shape: hand). */
int func_002CE3A0(int a0, int a1) {
    extern int D_003517C8;
    extern int D_003517B0;
    extern int func_0001E1A8();
    extern int func_002CE3A0();
    D_003517C8 = a0;
    D_003517B0 = 1;
    return func_0001E1A8(a0, a1, 0, 5);
}
...
/* func_002EEBB0 — 5 words. MATCH 100% (shape: hand). */
int func_002EEBB0(void) {
    extern int D_00326F5C;
    extern int func_002F6B08();
    extern int func_002EEBB0();
    return func_002F6B08((int)&D_00326F5C, 0x256DC);
}
...
/* func_002EF9FC — 5 words. MATCH 100% (shape: hand). */
void func_002EF9FC(void) {
    extern int D_003518A8;
    extern int D_003518A4;
    extern int func_002EF9FC();
    D_003518A4 = D_003518A8;
}
/* func_002EFA48 — 7 words. MATCH 100% (shape: hand). */
void func_002EFA48(void) {
    extern int D_003268E4;
    extern int D_003518B0;
    extern int func_002EFA48();
    D_003518B0 = (D_003268E4 & 1) ^ 1;
}
/* func_002EF9E4 — 6 words. MATCH 100% (shape: hand). */
void func_002EF9E4(void) {
    extern int D_003268E4;
    extern int D_003518A8;
    extern int func_002EF9E4();
    D_003518A8 = D_003268E4 & 1;
}
...
/* func_002EFB1C — 6 words. MATCH 100% (shape: hand). */
void *func_002EFB1C(void *a0, void *a1) {
...
/* func_002EFBE4 — 6 words. MATCH 100% (shape: hand). */
void *func_002EFBE4(void *a0, void *a1) {
    struct vec2f { f32 x, y; } *arg0 = a0, *arg1 = a1;
    extern int func_002EFBE4();
    *arg0 = *arg1;
    return arg0;
...
/* func_002EFCB0 — 6 words. MATCH 100% (shape: hand). */
void *func_002EFCB0(void *a0, void *a1) {
    struct vec2f { f32 x, y; } *arg0 = a0, *arg1 = a1;
    extern int func_002EFCB0();
    *arg0 = *arg1;
    return arg0;
...
/* func_002EFD80 — 6 words. MATCH 100% (shape: hand). */
void *func_002EFD80(void *a0, void *a1) {
    struct vec2f { f32 x, y; } *arg0 = a0, *arg1 = a1;
    extern int func_002EFD80();
    *arg0 = *arg1;
    return arg0;
...
/* func_002EFEC4 — 7 words. MATCH 100% (shape: hand). */
void func_002EFEC4(void) {
    extern int D_003268E8;
    extern int D_00351908;
    extern int func_002EFEC4();
    D_00351908 = (unsigned int)(D_003268E8 ^ 3) < 1;
}
/* func_002EFF40 — 5 words. MATCH 100% (shape: hand). */
void func_002EFF40(void) {
    extern int D_00351724;
    extern int D_00351910;
    extern int func_002EFF40();
    D_00351910 = D_00351724;
}
...
/* func_002EFF78 — 13 words. MATCH 100% (shape: hand). */
int func_002EFF78(void) {
    extern int func_002EF830();
    extern int D_0035190C;
    extern int D_00351724;
    extern int func_002EFF78();
    return func_002EF830() ? D_00351724 : D_0035190C;
}
/* func_002EFFAC — 5 words. MATCH 100% (shape: hand). */
void func_002EFFAC(void) {
    extern int D_00351714;
    extern int D_00351918;
    extern int func_002EFFAC();
    D_00351918 = D_00351714;
}
...
/* func_002EFFE4 — 13 words. MATCH 100% (shape: hand). */
int func_002EFFE4(void) {
    extern int func_002EF830();
    extern int D_00351914;
    extern int D_00351714;
    extern int func_002EFFE4();
    return func_002EF830() ? D_00351714 : D_00351914;
}
/* func_002F0018 — 5 words. MATCH 100% (shape: hand). */
void func_002F0018(void) {
    extern int D_0035171C;
    extern int D_00351920;
    extern int func_002F0018();
    D_00351920 = D_0035171C;
}
...
/* func_002F0050 — 13 words. MATCH 100% (shape: hand). */
int func_002F0050(void) {
    extern int func_002EF830();
    extern int D_0035191C;
    extern int D_0035171C;
    extern int func_002F0050();
    return func_002EF830() ? D_0035171C : D_0035191C;
}
/* func_002F0084 — 5 words. MATCH 100% (shape: hand). */
void func_002F0084(void) {
    extern int D_00351738;
    extern int D_00351928;
    extern int func_002F0084();
    D_00351928 = D_00351738;
}
/* func_002F00BC — 13 words. MATCH 100% (shape: hand). */
int func_002F00BC(void) {
    extern int func_002EF830();
    extern int D_00351924;
    extern int D_00351738;
    extern int func_002F00BC();
    return func_002EF830() ? D_00351738 : D_00351924;
}
...
/* func_002F04D4 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[22]; } S_func_002F04D4;
S_func_002F04D4 *func_002F04D4(S_func_002F04D4 *dst, S_func_002F04D4 *src) { *dst = *src; return dst; }
...
/* func_002F063C — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[22]; } S_func_002F063C;
S_func_002F063C *func_002F063C(S_func_002F063C *dst, S_func_002F063C *src) { *dst = *src; return dst; }
...
/* func_002F0780 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[22]; } S_func_002F0780;
S_func_002F0780 *func_002F0780(S_func_002F0780 *dst, S_func_002F0780 *src) { *dst = *src; return dst; }
...
/* func_002F08E0 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[22]; } S_func_002F08E0;
S_func_002F08E0 *func_002F08E0(S_func_002F08E0 *dst, S_func_002F08E0 *src) { *dst = *src; return dst; }
...
/* func_002F10EC — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[484]; } S_func_002F10EC;
S_func_002F10EC *func_002F10EC(S_func_002F10EC *dst, S_func_002F10EC *src) { *dst = *src; return dst; }
...
/* func_002F13D4 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 int x[22]; } S_func_002F13D4;
S_func_002F13D4 *func_002F13D4(S_func_002F13D4 *dst, S_func_002F13D4 *src) { *dst = *src; return dst; }
...
/* func_002F1538 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[22]; } S_func_002F1538;
S_func_002F1538 *func_002F1538(S_func_002F1538 *dst, S_func_002F1538 *src) { *dst = *src; return dst; }
...
/* func_002F167C — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[22]; } S_func_002F167C;
S_func_002F167C *func_002F167C(S_func_002F167C *dst, S_func_002F167C *src) { *dst = *src; return dst; }
...
/* func_002F17C0 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[22]; } S_func_002F17C0;
S_func_002F17C0 *func_002F17C0(S_func_002F17C0 *dst, S_func_002F17C0 *src) { *dst = *src; return dst; }
...
/* func_002F1904 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 int x[22]; } S_func_002F1904;
S_func_002F1904 *func_002F1904(S_func_002F1904 *dst, S_func_002F1904 *src) { *dst = *src; return dst; }
...
/* func_002F1A74 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 char x[748]; } S_func_002F1A74;
S_func_002F1A74 *func_002F1A74(S_func_002F1A74 *dst, S_func_002F1A74 *src) { *dst = *src; return dst; }
...
/* func_002F1F88 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[10]; } S_func_002F1F88;
S_func_002F1F88 *func_002F1F88(S_func_002F1F88 *dst, S_func_002F1F88 *src) { *dst = *src; return dst; }
...
/* func_002F24F4 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[248]; } S_func_002F24F4;
S_func_002F24F4 *func_002F24F4(S_func_002F24F4 *dst, S_func_002F24F4 *src) { *dst = *src; return dst; }
...
/* func_002F2644 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[248]; } S_func_002F2644;
S_func_002F2644 *func_002F2644(S_func_002F2644 *dst, S_func_002F2644 *src) { *dst = *src; return dst; }
...
/* func_002F2794 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[62]; } S_func_002F2794;
S_func_002F2794 *func_002F2794(S_func_002F2794 *dst, S_func_002F2794 *src) { *dst = *src; return dst; }
...
/* func_002F28E4 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[278]; } S_func_002F28E4;
S_func_002F28E4 *func_002F28E4(S_func_002F28E4 *dst, S_func_002F28E4 *src) { *dst = *src; return dst; }
...
/* func_002F2A34 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[278]; } S_func_002F2A34;
S_func_002F2A34 *func_002F2A34(S_func_002F2A34 *dst, S_func_002F2A34 *src) { *dst = *src; return dst; }
...
/* func_002F2B9C — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[248]; } S_func_002F2B9C;
S_func_002F2B9C *func_002F2B9C(S_func_002F2B9C *dst, S_func_002F2B9C *src) { *dst = *src; return dst; }
...
/* func_002F2D1C — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[248]; } S_func_002F2D1C;
S_func_002F2D1C *func_002F2D1C(S_func_002F2D1C *dst, S_func_002F2D1C *src) { *dst = *src; return dst; }
...
/* func_002F2E9C — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[62]; } S_func_002F2E9C;
S_func_002F2E9C *func_002F2E9C(S_func_002F2E9C *dst, S_func_002F2E9C *src) { *dst = *src; return dst; }
...
/* func_002F301C — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[278]; } S_func_002F301C;
S_func_002F301C *func_002F301C(S_func_002F301C *dst, S_func_002F301C *src) { *dst = *src; return dst; }
...
/* func_002F319C — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[278]; } S_func_002F319C;
S_func_002F319C *func_002F319C(S_func_002F319C *dst, S_func_002F319C *src) { *dst = *src; return dst; }
...
/* func_002F3754 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[248]; } S_func_002F3754;
S_func_002F3754 *func_002F3754(S_func_002F3754 *dst, S_func_002F3754 *src) { *dst = *src; return dst; }
...
/* func_002F38E0 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 int x[512]; } S_func_002F38E0;
S_func_002F38E0 *func_002F38E0(S_func_002F38E0 *dst, S_func_002F38E0 *src) { *dst = *src; return dst; }
...
/* func_002F4484 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 int x[512]; } S_func_002F4484;
S_func_002F4484 *func_002F4484(S_func_002F4484 *dst, S_func_002F4484 *src) { *dst = *src; return dst; }
...
/* func_002F455C — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[512]; } S_func_002F455C;
S_func_002F455C *func_002F455C(S_func_002F455C *dst, S_func_002F455C *src) { *dst = *src; return dst; }
...
/* func_002F4678 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 char x[64]; } S_func_002F4678;
S_func_002F4678 *func_002F4678(S_func_002F4678 *dst, S_func_002F4678 *src) { *dst = *src; return dst; }
/* func_002F4718 — 11 words. MATCH 100% (shape: hand). */
void func_002F4718(int a0) {
    extern int func_002EF7C0();
    extern int D_003268E0;
    extern int func_002F4718();
    func_002EF7C0(a0);
    D_003268E0 = a0;
}
/* func_002F4744 — 11 words. MATCH 100% (shape: hand). */
void func_002F4744(int a0) {
    extern int func_002EF7C0();
    extern int D_003268E4;
    extern int func_002F4744();
    func_002EF7C0(a0);
    D_003268E4 = a0;
}
/* func_002F47B4 — 11 words. MATCH 100% (shape: hand). */
void func_002F47B4(int a0) {
    extern int func_002EF7C0();
    extern int D_00326908;
    extern int func_002F47B4();
    func_002EF7C0(a0);
    D_00326908 = a0;
}
/* func_002F47E0 — 5 words. MATCH 100% (shape: hand). */
void func_002F47E0(void) {
    extern int D_00326908;
    extern int D_00358158;
    extern int func_002F47E0();
    D_00358158 = D_00326908;
}
...
/* func_002F4818 — 13 words. MATCH 100% (shape: hand). */
int func_002F4818(void) {
    extern int func_002EF830();
    extern int D_00358154;
    extern int D_00326908;
    extern int func_002F4818();
    return func_002EF830() ? D_00326908 : D_00358154;
}
/* func_002F484C — 5 words. MATCH 100% (shape: hand). */
void func_002F484C(void) {
    extern int D_00326C10;
    extern int D_00358160;
    extern int func_002F484C();
    D_00358160 = D_00326C10;
}
...
/* func_002F4884 — 13 words. MATCH 100% (shape: hand). */
int func_002F4884(void) {
    extern int func_002EF830();
    extern int D_0035815C;
    extern int D_00326C10;
    extern int func_002F4884();
    return func_002EF830() ? D_00326C10 : D_0035815C;
}
/* func_002F48B8 — 5 words. MATCH 100% (shape: hand). */
void func_002F48B8(void) {
    extern int D_00326C14;
    extern int D_00358168;
    extern int func_002F48B8();
    D_00358168 = D_00326C14;
}
...
/* func_002F48F0 — 13 words. MATCH 100% (shape: hand). */
int func_002F48F0(void) {
    extern int func_002EF830();
    extern int D_00358164;
    extern int D_00326C14;
    extern int func_002F48F0();
    return func_002EF830() ? D_00326C14 : D_00358164;
}
...
/* func_002F4AE8 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[278]; } S_func_002F4AE8;
S_func_002F4AE8 *func_002F4AE8(S_func_002F4AE8 *dst, S_func_002F4AE8 *src) { *dst = *src; return dst; }
...
/* func_002F4CB4 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[278]; } S_func_002F4CB4;
S_func_002F4CB4 *func_002F4CB4(S_func_002F4CB4 *dst, S_func_002F4CB4 *src) { *dst = *src; return dst; }
...
/* func_002F4E70 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 short x[278]; } S_func_002F4E70;
S_func_002F4E70 *func_002F4E70(S_func_002F4E70 *dst, S_func_002F4E70 *src) { *dst = *src; return dst; }
...
/* func_002F5008 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 char x[32]; } S_func_002F5008;
S_func_002F5008 *func_002F5008(S_func_002F5008 *dst, S_func_002F5008 *src) { *dst = *src; return dst; }
...
/* func_002F5164 — 12 words. MATCH 100% (shape: struct-copy). */
typedef struct {
 int x[22]; } S_func_002F5164;
S_func_002F5164 *func_002F5164(S_func_002F5164 *dst, S_func_002F5164 *src) { *dst = *src; return dst; }
...
/* func_002F5580 — 8 words. MATCH 100% (shape: hand). */
int func_002F5580(void) {
    extern int ehsys_B2B9FEFA();
    extern int func_002F5580();
    return *(int *)((char *)ehsys_B2B9FEFA() + 4);
}
...
/* func_002F5600 — 9 words. MATCH 100% (shape: hand). */
int func_002F5600(void) {
    extern int func_002EF7C0();
    extern int D_0035178C;
    extern int func_002F5600();
    func_002EF7C0();
    return D_0035178C;
}
...
/* func_002F5A6C — 9 words. MATCH 100% (shape: hand). */
void func_002F5A6C(void) {
    extern int func_0001D4D4();
    extern int D_003593D0;
    extern int func_002F5A6C();
    D_003593D0 = func_0001D4D4();
}
...
/* func_002F5AEC — 9 words. MATCH 100% (shape: hand). */
void func_002F5AEC(void) {
    extern int func_00042498();
    extern int D_003593D8;
    extern int func_002F5AEC();
    D_003593D8 = func_00042498();
}
...
/* func_002F5DA0 — 5 words. MATCH 100% (shape: hand). */
void func_002F5DA0(void) {
    extern int D_00351788;
    extern int D_003593E8;
    extern int func_002F5DA0();
    D_003593E8 = D_00351788;
}
...
/* func_002F5DD8 — 13 words. MATCH 100% (shape: hand). */
int func_002F5DD8(void) {
    extern int func_002EF830();
    extern int D_003593E4;
    extern int D_00351788;
    extern int func_002F5DD8();
    return func_002EF830() ? D_00351788 : D_003593E4;
}
/* func_002F5E0C — 11 words. MATCH 100% (shape: hand). */
void func_002F5E0C(int a0) {
    extern int func_002EF7C0();
    extern int D_00351788;
    extern int func_002F5E0C();
    func_002EF7C0(a0);
    D_00351788 = a0;
}
/* func_002F5E38 — 9 words. MATCH 100% (shape: hand). */
void func_002F5E38(void) {
    extern int func_00016600();
    extern int D_003593F0;
    extern int func_002F5E38();
    D_003593F0 = func_00016600();
}
...
/* func_002F5EB8 — 9 words. MATCH 100% (shape: hand). */
void func_002F5EB8(void) {
    extern int func_0015F408();
    extern int D_003593F8;
    extern int func_002F5EB8();
    D_003593F8 = func_0015F408();
}
...
/* func_002F63CC — 11 words. MATCH 100% (shape: hand). */
void func_002F63CC(int a0) {
    extern int func_002EF7C0();
    extern int D_0035171C;
    extern int func_002F63CC();
    func_002EF7C0(a0);
    D_0035171C = a0;
}
/* func_002F643C — 9 words. MATCH 100% (shape: hand). */
void *func_002F643C(void) {
    extern int func_002EF830();
    extern int D_0034DF44;
    extern int func_002F643C();
    func_002EF830();
    return &D_0034DF44;
}
/* func_002F6460 — 9 words. MATCH 100% (shape: hand). */
void *func_002F6460(void) {
    extern int func_002EF830();
    extern int D_0034C6C8;
    extern int func_002F6460();
    func_002EF830();
    return &D_0034C6C8;
}
/* func_002F6484 — 9 words. MATCH 100% (shape: hand). */
void *func_002F6484(void) {
    extern int func_002EF830();
    extern int D_0034CA64;
    extern int func_002F6484();
    func_002EF830();
    return &D_0034CA64;
}
/* func_002F64A8 — 9 words. MATCH 100% (shape: hand). */
void *func_002F64A8(void) {
    extern int func_002EF830();
    extern int D_0034E660;
    extern int func_002F64A8();
    func_002EF830();
    return &D_0034E660;
}
/* func_002F64CC — 9 words. MATCH 100% (shape: hand). */
void *func_002F64CC(void) {
    extern int func_002EF830();
    extern int D_0034D728;
    extern int func_002F64CC();
    func_002EF830();
    return &D_0034D728;
}
...
/* func_002F6AC8 — 13 words. MATCH 100% (shape: m2c). */
s32 func_002F6AC8(void) {
    extern int D_00359410;
    extern int func_002F6AC8();
    if (D_00359410 == NULL) {
        return 0;
    }
    return ((s32 (*)()) D_00359410)();
}
...
int func_000D85B8(int a0, int a1, int a2, int a3, int t0) {
    extern int func_000820D8();
    extern int func_000D85B8();
    return !((func_000820D8((*(unsigned short *)((char *)(a0) + 0x2)), 0xB, 0xE, a3, t0)) < 0x4);
}
/* func_000ED930 — 11 words. MATCH 100% (shape: hand). */
int func_000ED930(int a0, int a1, int a2) {
    extern int func_000788F4();
    extern int func_000ED930();
    return (func_000788F4((*(unsigned short *)((char *)(a0) + 0x2)), (*(unsigned short *)((char *)(a0) + 0x4)), 0xFB6)) < 0x2;
}
/* func_000F0144 — 11 words. MATCH 100% (shape: hand). */
int func_000F0144(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_00078AAC();
    extern int func_000F0144();
    return (func_00078AAC((*(unsigned short *)((char *)(a0) + 0x2)), (*(unsigned short *)((char *)(a0) + 0x4)), 0x1C74, a3, t0, t1)) != 0;
}
...
/* func_000F1B18 — 11 words. MATCH 100% (shape: hand). */
int func_000F1B18(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_00078AAC();
    extern int func_000F1B18();
    return (func_00078AAC((*(unsigned short *)((char *)(a0) + 0x2)), 0xB, (*(unsigned short *)((char *)(a0) + 0x0)), a3, t0, t1)) != 0;
}
...
/* func_000F5B48 — 12 words. MATCH 100% (shape: hand). */
int func_000F5B48(int a0, int a1, int a2, int a3) {
    extern int func_00079008();
    extern int func_000F5B48();
    return !((func_00079008((*(unsigned short *)((char *)(a0) + 0x2)), (*(unsigned short *)((char *)(a0) + 0x4)), (*(unsigned short *)((char *)(a0) + 0x0)), a3)) < 0);
}
...
int func_00144F70(int a0, int a1, int a2) {
    extern int func_0006161C();
    extern int func_00144F70();
...
/* func_0005FAE4 — 11 words. MATCH 100% (shape: trampoline). */
int func_0005FAE4(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0005F51C();
    extern int func_0005FAE4();
    return (func_0005F51C(a0, a1, a2, 0xE, 0, 0)) == 0xE;
}
/* func_000C6CF0 — 13 words. MATCH 100% (shape: trampoline). */
int func_000C6CF0(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0005BA60();
    extern int func_000C6CF0();
    func_0005BA60((*(unsigned short *)((char *)(a0) + 0x2)), (*(unsigned short *)((char *)(a0) + 0x4)), 0xFB6, 0x3, 0, t1);
    return 0x1;
}
/* func_000C9004 — 13 words. MATCH 100% (shape: trampoline). */
int func_000C9004(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0005BA60();
    extern int func_000C9004();
    func_0005BA60((*(unsigned short *)((char *)(a0) + 0x2)), (*(unsigned short *)((char *)(a0) + 0x4)), 0xFB6, 0x4, 0, t1);
    return 0x1;
}
/* func_000CDC24 — 11 words. MATCH 100% (shape: trampoline). */
int func_000CDC24(int a0, int a1, int a2) {
    extern int func_0006DC44();
    extern int func_000CDC24();
    func_0006DC44((*(unsigned short *)((char *)(a0) + 0x2)), (*(unsigned short *)((char *)(a0) + 0x4)), 0);
    return 0x1;
}
/* func_000CF670 — 13 words. MATCH 100% (shape: trampoline). */
int func_000CF670(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_0005BA60();
    extern int func_000CF670();
    func_0005BA60((*(unsigned short *)((char *)(a0) + 0x2)), (*(unsigned short *)((char *)(a0) + 0x4)), 0x14D6, 0x2, 0, t1);
    return 0x1;
}
/* func_00116E84 — 12 words. MATCH 100% (shape: trampoline). */
int func_00116E84(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_00074230();
    extern int D_00351714;
    extern int func_00116E84();
    func_00074230(D_00351714, (*(unsigned short *)((char *)(a0) + 0x0)), 0x1, 0, t0, t1);
    return 0;
}
/* func_001FEE54 — 11 words. MATCH 100% (shape: trampoline). */
int func_001FEE54(int a0, int a1, int a2, int a3) {
    extern int func_001FEC10();
    extern int func_001FEE54();
    return !((func_001FEC10(a0, (*(unsigned short *)((char *)(a0) + 0x2)), 0, 0)) < 0);
}
/* func_001FEE80 — 11 words. MATCH 100% (shape: trampoline). */
int func_001FEE80(int a0, int a1, int a2, int a3) {
    extern int func_001FEC10();
    extern int func_001FEE80();
    return !((func_001FEC10(a0, (*(unsigned short *)((char *)(a0) + 0x2)), 0, 0x1)) < 0);
}
/* func_001FEEAC — 11 words. MATCH 100% (shape: trampoline). */
int func_001FEEAC(int a0, int a1, int a2, int a3) {
    extern int func_001FEC10();
    extern int func_001FEEAC();
    return !((func_001FEC10(a0, (*(unsigned short *)((char *)(a0) + 0x2)), 0x1, 0)) < 0);
}
/* func_002254E4 — 11 words. MATCH 100% (shape: trampoline). */
int func_002254E4(int a0, int a1, int a2, int a3, int t0, int t1, int t2) {
    extern int func_001A0D94();
    extern int func_002254E4();
    return !((func_001A0D94((*(unsigned short *)((char *)(a0) + 0x2)), 0x1844, 0, a3, t0, t1, t2)) > 0);
}

/* func_000DAFFC — 11 words. MATCH 100% (shape: hand). */
int func_000DAFFC(void) {
    extern int func_0017B9C4();
    extern int func_000DAFFC();
    return (func_0017B9C4() < 2) ? 0 : 2;
}
/* func_002BB704 — 11 words. MATCH 100% (shape: hand). */
int func_002BB704(void) {
    extern int func_0017CA90();
    extern int func_002BB704();
    return (func_0017CA90() != 0x1FC7) ? 1 : 0xA;
}
/* func_002DC1E0 — 11 words. MATCH 100% (shape: hand). */
int func_002DC1E0(void) {
    extern int func_002DBF3C();
    extern int D_0034BFAC;
    extern int func_002DC1E0();
    int v = func_002DBF3C();
    if (v > 0) {
        D_0034BFAC = 0;
    }
...
/* func_00163B14 — 15 words. MATCH 100% (shape: hand). */
int func_00163B14(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_00161AE0();
    extern int func_00163B00();
    extern int func_00163B14();
    return func_00161AE0(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00163B00), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x4);
}
/* func_001670C0 — 16 words. MATCH 100% (shape: hand). */
int func_001670C0(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_00161AE0();
    extern int func_00162DD0();
    extern int func_001670C0();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161AE0(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x12);
}
/* func_00169880 — 15 words. MATCH 100% (shape: hand). */
int func_00169880(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_00161AE0();
    extern int func_00162B50();
    extern int func_00169880();
    return func_00161AE0(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162B50), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x2);
}
/* func_00169ACC — 16 words. MATCH 100% (shape: hand). */
int func_00169ACC(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_00161AE0();
    extern int func_00162B50();
    extern int func_00169ACC();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161AE0(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162B50), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x12);
}
/* func_0016E618 — 16 words. MATCH 100% (shape: hand). */
int func_0016E618(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_00161AE0();
    extern int func_00162B50();
    extern int func_0016E618();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161AE0(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162B50), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x8);
}
/* func_0016FE3C — 16 words. MATCH 100% (shape: hand). */
int func_0016FE3C(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_00161AE0();
    extern int func_00162DD0();
    extern int func_0016FE3C();
    int local = *(short *)((char *)a0 + 0x2);
    return func_00161AE0(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x4);
}

/* func_00167280 — 18 words. MATCH 100% (shape: hand). */
int func_00167280(int a0, int a1, int a2, int a3, int t0) {
    extern int func_001621C4();
    extern int func_0016713C();
    extern short *D_0034D434;
    extern int func_00167280();
    int r = func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), (int)&func_0016713C, 0, (*(int *)((char *)(a0) + 8)), 0x10000);
    *D_0034D434 = 0x1935;
    return r;
}
/* func_0016CF1C — 18 words. MATCH 100% (shape: hand). */
int func_0016CF1C(int a0, int a1, int a2, int a3, int t0) {
    extern int func_001621C4();
    extern int func_0016713C();
    extern short *D_0034D434;
    extern int func_0016CF1C();
    int r = func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), (int)&func_0016713C, 0, (*(int *)((char *)(a0) + 8)), 1);
    *D_0034D434 = 0x201E;
    return r;
}
/* func_0016DCC0 — 16 words. MATCH 100% (shape: hand). */
int func_0016DCC0(int a0, int a1, int a2, int a3, int t0) {
    extern int func_001621C4();
    extern int func_00162E60();
    extern int func_0016DCC0();
    int local = 0xFFFF;
    return func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), (int)&func_00162E60, (int)&local, (*(int *)((char *)(a0) + 8)), 0x10000);
}
/* func_0016E594 — 25 words. MATCH 100% (shape: hand). */
int func_0016E594(int a0, int a1, int a2, int a3, int t0) {
    extern int func_001621C4();
    extern int func_0016E3C4();
    extern short *D_0034D434;
    extern int func_0016E594();
    int r;
    *(short *)((char *)D_0034D434 + 8) = 0;
    r = func_001621C4(a1, (*(unsigned short *)((char *)(a0) + 0)), (int)&func_0016E3C4, 0, (*(int *)((char *)(a0) + 8)), 0x10000);
    *D_0034D434 = 0x219E;
    *(short *)((char *)D_0034D434 + 8) = 3;
    return r;
}

/* func_0016922C — 16 words. MATCH 100% (shape: hand). */
int func_0016922C(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001627D4();
    extern int func_00162DD0();
    extern int func_0016922C();
    int local = *(short *)((char *)a0 + 0x2);
    return func_001627D4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0xC);
}
/* func_0016A6F4 — 15 words. MATCH 100% (shape: hand). */
int func_0016A6F4(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001627D4();
    extern int func_0016A6C8();
    extern int func_0016A6F4();
    return func_001627D4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_0016A6C8), ((int)&a2), (*(int *)((char *)(a0) + 8)), 0x1);
}
/* func_0016DED0 — 16 words. MATCH 100% (shape: hand). */
int func_0016DED0(int a0, int a1, int a2, int a3, int t0, int t1) {
    extern int func_001627D4();
    extern int func_00162DD0();
    extern int func_0016DED0();
    int local = *(short *)((char *)a0 + 0x2);
    return func_001627D4(a1, (*(unsigned short *)((char *)(a0) + 0)), ((int)&func_00162DD0), ((int)&local), (*(int *)((char *)(a0) + 8)), 0x8);
}


/* func_00223778 — 12 words. MATCH 100% (shape: hand). */
int func_00223778(void *a0) {
    extern int func_00186960();
    extern int func_00223778();
    return !(func_00186960(a0, 1 - *(unsigned short *)((char *)a0 + 2), 0) < 2);
}


/* func_00205BDC — 15 words. MATCH 100% (shape: hand). */
int func_00205BDC(void *a0, int a1) {
    extern int func_00205108();
    extern int func_00205BDC();
    unsigned short field2 = *(unsigned short *)((char *)a0 + 2);
    unsigned short fieldA = *(unsigned short *)((char *)a0 + 0xA);
    return func_00205108(a0, a1, 1 << (((field2 ^ fieldA) << 4) + 0xB), 0) != 0;
}
/* func_0023C47C — 14 words. MATCH 100% (shape: hand). */
int func_0023C47C(void *a0, int a1) {
    extern int func_00205108();
