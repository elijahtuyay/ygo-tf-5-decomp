...
/* func_0000023C — 17 words. MATCH 100% (shape: m2c). */
void func_0000023C(void) {
    func_000015B8();
    if (D_00006A4C > 0) {
        ehsys_F6414A71(D_00006A4C, D_00006A50);
        ehsys_ED1410E0(D_00006A4C);
    }
}

/* func_000015B8 — 12 words. MATCH 100% (shape: m2c). */
void func_000015B8(void) {
    ehsys_6E42DDCD();
    ehsys_20E340D9(D_00006A48, D_00006A2C);
}
